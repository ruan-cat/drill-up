...
//	
//		★存在的问题：
//			1.问题：使用 this.x + rect.x 总会有一些偏移，经测试不是资源图片问题。
//			  解决：【已解决】，除了窗口x、矩形x，还有画布的内边距，因为窗口坐标和画布坐标直接有内边距，所以出现了偏移。
//			2.问题：界面切换时，指针会停留在它默认的位置，然后再开始移动。（2023/7/30）
...
//=============================================================================
	...
	DrillUp.g_MCu_PluginTip_baseList = ["Drill_CoreOfBallistics.js 数学模型-弹道核心"];
	//==============================
	// * 提示信息 - 报错 - 缺少基础插件
	//			
