 ...
 *   更多内容也去看看 "9.物体触发 > 关于物体触发-固定区域.docx"。
 * 区域主体：
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_COFA_PluginTip_curName = "Drill_CoreOfFixedArea.js 物体触发-固定区域核心";
	DrillUp.g_COFA_PluginTip_baseList = [];
