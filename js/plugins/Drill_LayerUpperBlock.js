...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_LUB_PluginTip_curName = "Drill_LayerUpperBlock.js 图块-上层图块四通行阻碍";
	DrillUp.g_LUB_PluginTip_baseList = [];
	//==============================
	// * 提示信息 - 报错 - 顺序错误
	//==============================
	DrillUp.drill_LUB_getPluginTip_ErrorOrder = function(){
		return "【" + DrillUp.g_LUB_PluginTip_curName + "】\n插件顺序不对，Drill_LayerWallBlock 图块-墙壁阻塞器 插件必须放在该插件后面。";
	};
...
　　var DrillUp = DrillUp || {}; 
	...
	if( Imported.Drill_LayerWallBlock ){
		alert( DrillUp.drill_LUB_getPluginTip_ErrorOrder() );
	}
