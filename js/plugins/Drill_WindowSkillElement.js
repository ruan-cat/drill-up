...
//
//		★存在的问题：
//			1.问题：滚动条放入任何一个layer都会出现诡异bug，影响这个插件第7个sprite，不停地闪。
//			  解决：【已解决】，是因为贴图addChild之后，就没删除，造成的残留。
//
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_WSE_PluginTip_curName = "Drill_WindowSkillElement.js 控件-技能窗口块元素";
	DrillUp.g_WSE_PluginTip_baseList = [];
