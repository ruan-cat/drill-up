 ...
 * 4.你可以了解基本的按键定义，去看看 "1.系统 > 关于输入设备核心.docx"。
...
//			5.不考虑的方面：
//				> 敌人的生命值在这里完全不考虑（高级ai再考虑）
//				> 自定义炸弹的样子，形状，火力，这里完全不考虑（只设计标准炸弹即可）
//				> 道具完全不考虑
//				> 推炸弹完全不考虑
//				> 移动速度目前不计影响，但是后面高级AI需要把这个考虑进去。
