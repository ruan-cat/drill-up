//=============================================================================
// Drill_HtmlDynamicSnapshotSprite.js
//=============================================================================

/*:
 * @plugindesc [v1.2]        游戏窗体 - 天窗层的多层动态快照
 * @author Drill_up
 * 
 * @Drill_LE_param "动态快照层-%d"
 * @Drill_LE_parentKey "---动态快照层组%d至%d---"
 * @Drill_LE_var "DrillUp.g_HDSS_layers_length"
 * 
 * 
 * @help 
 * =============================================================================
 * +++ Drill_HtmlDynamicSnapshotSprite +++
 * 作者：Drill_up
 ...
 *      但不包括天窗层的贴图，以及动态快照自己。
 *   (3.默认情况下 所有动态快照 都是隐藏的，需要插件指令手动显示。
 *      另外，如果开了存储功能，插件指令操作的变化结果是永久性的。
 * 预加载：
 *   (1.插件中可自定义指定资源是否预加载，
 *      预加载相关介绍可以去看看"1.系统 > 关于预加载.docx"。
 * 设计：
 *   (1.由于动态快照是游戏实时的画面，这也意味着你可以将当期游戏
 *      画面进行任意切割、平移、旋转、叠加多个，这也使得你可以设
 *      计出次元斩的效果。
 *
 * -----------------------------------------------------------------------------
 * ----关联文件
 ...
 * 你可以通过插件指令手动修改各个属性：
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 显示
 * 插件指令：>天窗层动态快照 : 动态快照变量[21] : 显示
 * 插件指令：>天窗层动态快照 : 批量动态快照[7,8] : 显示
 * 插件指令：>天窗层动态快照 : 批量动态快照变量[21,22] : 显示
 * 插件指令：>天窗层动态快照 : 全部动态快照 : 显示
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 显示
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 隐藏
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 暂停
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 继续
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 切换混合模式[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 切换图片层级[10]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 透明度[255] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 透明度变量[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 旋转[90] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 旋转变量[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 转速[10.0] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 转速变量[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 缩放X[1.2] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 缩放X变量%[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 缩放Y[1.2] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 缩放Y变量%[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 斜切X[0.2] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 斜切X变量%[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 斜切Y[0.2] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性 : 斜切Y变量%[21] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 立即还原所有单属性
 * 
 * 1.前半部分（动态快照变量[21]）和 后半部分（显示）
 ...
 * 你可以通过插件指令手动设置移动：
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-匀速移动 : 位置[100,100] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-匀速移动 : 位置变量[25,26] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-弹性移动 : 位置[100,100] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-弹性移动 : 位置变量[25,26] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-增减速移动 : 位置[100,100] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-增减速移动 : 位置变量[25,26] : 时间[60]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到-立即归位
 * 
 * 1.前半部分（动态快照[11]）和 后半部分（移动到-匀速移动 : 位置[100,100] : 时间[60]）
 ...
 * 你可以通过插件指令手动修改中心锚点：
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改中心锚点 : 锚点[0.5,0.5]
 * 插件指令：>天窗层动态快照 : 动态快照变量[21] : 修改中心锚点 : 锚点[0.5,0.5]
 * 
 ...
 * -----------------------------------------------------------------------------
 * ----可选设定 - 获取属性
 * 你可以通过插件指令来获取 天窗层动态快照 的属性值：
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 位置X : 变量[21]
 * 插件指令：>天窗层动态快照 : 动态快照变量[21] : 获取属性 : 位置X : 变量[21]
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 位置X : 变量[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 位置Y : 变量[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 透明度 : 变量[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 旋转 : 变量[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 转速 : 变量[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 缩放X : 变量%[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 缩放Y : 变量%[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 斜切X : 变量%[21]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 获取属性 : 斜切Y : 变量%[21]
 * 
 * 1.前半部分（动态快照[11]）和 后半部分（获取属性 : 位置X : 变量[21]）
 ...
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照变量[21] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 批量动态快照[7,8] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 批量动态快照变量[21,22] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 全部动态快照 : 隐藏(延迟) : 延迟执行时间[20]
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 显示(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 暂停(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 继续(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 透明度[255] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 透明度变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 旋转[90] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 旋转变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 转速[10.0] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 转速变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 缩放X[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 缩放X变量%[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 缩放Y[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 缩放Y变量%[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 斜切X[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 斜切X变量%[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 斜切Y[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 修改单属性(延迟) : 斜切Y变量%[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 还原所有单属性(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 立即取消全部延迟指令
 * 
 * 1.前半部分（动态快照[11]）和 后半部分（隐藏(延迟) : 延迟执行时间[20]）
 ...
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-匀速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-匀速移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-弹性移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-弹性移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-增减速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-增减速移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 移动到(延迟)-延迟归位 : 延迟执行时间[20]
 * 
 * 1.前半部分（动态快照[11]）和 后半部分（移动到(延迟)-匀速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]）
 *   的参数可以随意组合。一共有5*7种组合方式。
 ...
 * 测试结果1：  200个事件的地图中，平均消耗为：【108.10ms】
 *              100个事件的地图中，平均消耗为：【42.10ms】
 *               50个事件的地图中，平均消耗为：【34.50ms】
 * 测试方法2：  在不同的界面中，进行性能测试。
 * 测试结果2：  战斗界面中，平均消耗为：【41.46ms】
 *              菜单界面中，平均消耗为：【38.73ms】
 *
 ...
 * @param 资源-动态快照的遮罩
 * @parent ---贴图---
 * @desc 注意，动态快照本身不需要资源，此配置为动态快照的遮罩资源，即遮挡 动态快照贴图对象 用。
 * @default (需配置)天窗层动态快照遮罩
 * @require 1
 ...
 * @param 整体缩放 X
 * @parent ---3d效果---
 * @desc 动态快照的缩放X值，默认比例1.0。缩放将会使得动态快照看起来旋转具有一定的3d效果。
 * @default 1.0
 * 
 * @param 整体缩放 Y
 * @parent ---3d效果---
 * @desc 动态快照的缩放Y值，默认比例1.0。缩放将会使得动态快照看起来旋转具有一定的3d效果。
 * @default 1.0
 * 
 * @param 整体斜切 X
 * @parent ---3d效果---
 * @desc 动态快照的斜切X值，默认比例0.0。斜切将会使得动态快照看起来旋转具有一定角度。
 * @default 0.0
 * 
 * @param 整体斜切 Y
 * @parent ---3d效果---
 * @desc 动态快照的斜切Y值，默认比例0.0。斜切将会使得动态快照看起来旋转具有一定角度。
 * @default 0.0
 * 
 * @param 整体再旋转角度
 * @parent ---3d效果---
 * @desc 在上述效果的基础上，动态快照再旋转的角度。
 * @default 0.0
 * 
 * 
 * @param ---自变化效果---
...
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
//		插件简称		HDSS（Html_Dynamic_Snapshot_Sprite）
//		临时全局变量	DrillUp.g_HDSS_xxx
//		临时局部变量	this._drill_HDSS_xxx
//		存储数据变量	$gameSystem._drill_HDSS_xxx
//		全局存储变量	无
//		覆盖重写方法	无
//
//<<<<<<<<性能记录<<<<<<<<
...
//		★时间复杂度		o(n^2)*o(贴图处理) 每帧
//		★性能测试因素	特效管理层
//		★性能测试消耗	108.1ms、42.1ms、34.5ms（Drill_HDSS_Sprite.update）19.3ms（drill_sprite_updateCommandChange）11.5ms（drill_sprite_updateAtt）7.3ms（drill_HDSS_updateController）
//		★最坏情况		暂无
//		★备注			动态快照的帧刷新函数，包含了渲染器的处理，所以消耗异常多。
//		
//		★优化记录		暂无
//
//<<<<<<<<插件记录<<<<<<<<
...
//				->销毁
//			
//			->动态快照控制器【Drill_HDSS_Controller】
//				->A主体
//				->B变换特性
//				->D指令叠加变化
//				->E延迟指令
//				->F自变化效果
//			->动态快照贴图【Drill_HDSS_Sprite】
//				->A主体
//				->B变换特性
//				->C对象绑定
//				->D指令叠加变化-控制器用
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_HDSS_PluginTip_curName = "Drill_HtmlDynamicSnapshotSprite.js 游戏窗体-天窗层的多层动态快照";
	DrillUp.g_HDSS_PluginTip_baseList = [
	...
	//==============================
	DrillUp.drill_HDSS_getPluginTip_NoBasePlugin = function(){
		if( DrillUp.g_HDSS_PluginTip_baseList.length == 0 ){ return ""; }
		var message = "【" + DrillUp.g_HDSS_PluginTip_curName + "】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对：";
		for(var i=0; i < DrillUp.g_HDSS_PluginTip_baseList.length; i++){
			message += "\n- ";
			message += DrillUp.g_HDSS_PluginTip_baseList[i];
		}
		return message;
	};
	//==============================
	// * 提示信息 - 报错 - 底层版本过低
	//==============================
	DrillUp.drill_HDSS_getPluginTip_LowVersion = function(){
		return "【" + DrillUp.g_HDSS_PluginTip_curName + "】\n游戏底层版本过低，插件基本功能无法执行。\n你可以去看\"rmmv软件版本（必看）.docx\"中的 \"旧工程升级至1.6版本\" 章节，来升级你的游戏底层版本。";
	};
	//==============================
	// * 提示信息 - 报错 - 强制更新提示
	//==============================
	DrillUp.drill_HDSS_getPluginTip_NeedUpdate_Ballistics = function(){
		return "【" + DrillUp.g_HDSS_PluginTip_curName + "】\n弹道核心插件版本过低，你需要更新 弹道核心 至少v2.2及以上版本。";
	};
	//==============================
	// * 提示信息 - 报错 - 控制器的非数字参数
	//==============================
	DrillUp.drill_HDSS_getPluginTip_controllerData_NotId = function( class_name ){
...
　　Imported.Drill_HtmlDynamicSnapshotSprite = true;
　　var DrillUp = DrillUp || {}; 
    DrillUp.parameters = PluginManager.parameters('Drill_HtmlDynamicSnapshotSprite');
	
	//==============================
	// * 静态数据 - 动态快照
	//				（~struct~HDSSCircle）
	//==============================
	DrillUp.drill_HDSS_circleInit = function( dataFrom ) {
		var data = {};
		...
		data['zIndex'] = Number( dataFrom["图片层级"] || 10);
		
		// > A主体 - 其它特性
		data['pause'] = false;
		data['src_img_mask'] = String( dataFrom["资源-动态快照的遮罩"] || "");
		data['src_img_file'] = "img/Special__layer/";
		
		
		// > B变换特性
		data['x'] = Number( dataFrom["平移-动态快照 X"] || 0);
		data['y'] = Number( dataFrom["平移-动态快照 Y"] || 0);
	...
	/*-----------------杂项------------------*/
	DrillUp.g_HDSS_saveEnabled = String(DrillUp.parameters["是否开启参数存储"] || "false") == "true" ;
	
	/*-----------------动态快照------------------*/
	DrillUp.g_HDSS_layers_length = 80;
	DrillUp.g_HDSS_layers = [];
	for (var i = 0; i < DrillUp.g_HDSS_layers_length; i++) {
		if( DrillUp.parameters["动态快照层-" + String(i+1) ] != undefined &&
			DrillUp.parameters["动态快照层-" + String(i+1) ] != "" ){
			var temp = JSON.parse(DrillUp.parameters["动态快照层-" + String(i+1) ]);
			DrillUp.g_HDSS_layers[i] = DrillUp.drill_HDSS_circleInit( temp );
		}else{
			DrillUp.g_HDSS_layers[i] = undefined;		//（强制设为空值，节约存储资源）
		}
	}
...
if( Imported.Drill_CoreOfDynamicSnapshot &&
	...
	if( typeof(Drill_COBa_ExtendTool) == "undefined" ){	//（弹道核心版本检测）
		alert( DrillUp.drill_HDSS_getPluginTip_NeedUpdate_Ballistics() );
	}
...
// ** ☆插件指令
//=============================================================================
var _drill_HDSS_pluginCommand = Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	_drill_HDSS_pluginCommand.call(this, command, args);
	if( command === ">天窗层动态快照" ){ // >天窗层动态快照 : 动态快照[1] : 显示
	
		/*-----------------对象组获取------------------*/
		var controllers = null;
		if( args.length >= 2 ){
			var unit = String(args[1]);
			if( controllers == null && unit.indexOf("批量动态快照[") != -1 ){
				unit = unit.replace("批量动态快照[","");
				unit = unit.replace("]","");
				controllers = [];
				var temp_arr = unit.split(/[,，]/);
				for( var k=0; k < temp_arr.length; k++ ){
					var controller_id = Number(temp_arr[k]);
					var temp_controller = $gameSystem._drill_HDSS_controllerTank[ controller_id -1 ];
					if( temp_controller == undefined ){ continue; }
					controllers.push( temp_controller );
				}
			}
			if( controllers == null && unit.indexOf("批量动态快照变量[") != -1 ){
				unit = unit.replace("批量动态快照变量[","");
				unit = unit.replace("]","");
				controllers = [];
				var temp_arr = unit.split(/[,，]/);
				for( var k=0; k < temp_arr.length; k++ ){
			...
			if( controllers == null && unit.indexOf("动态快照变量[") != -1 ){
				unit = unit.replace("动态快照变量[","");
				unit = unit.replace("]","");
			...
			if( controllers == null && unit.indexOf("动态快照[") != -1 ){
				unit = unit.replace("动态快照[","");
				unit = unit.replace("]","");
			...
			if( controllers == null && unit == "全部动态快照" ){
				controllers = [];
				for( var k=0; k < $gameSystem._drill_HDSS_controllerTank.length; k++ ){
					var temp_controller = $gameSystem._drill_HDSS_controllerTank[ k ];
					if( temp_controller == undefined ){ continue; }
					controllers.push( temp_controller );
				}
			}
		...
		if( args.length == 8 ){
			...
			if( type == "修改单属性" ){
				...
				if( temp1.indexOf("透明度[") != -1 ||
					...
					var num_list = this.drill_HDSS_getArgNumList(temp1);
					for( var k=0; k < controllers.length; k++ ){
...
//==============================
Game_Interpreter.prototype.drill_HDSS_getArgNumList = function( arg_str ){
...
// * 预加载 - 初始化
//==============================
var _drill_HDSS_preload_initialize = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function(){
	_drill_HDSS_preload_initialize.call(this);
	this.drill_HDSS_preloadInit();
}
//==============================
// * 预加载 - 版本校验
//==============================
if( Utils.generateRuntimeId == undefined ){
	alert( DrillUp.drill_HDSS_getPluginTip_LowVersion() );
}
//==============================
// * 预加载 - 执行资源预加载
//
...
//==============================
Game_Temp.prototype.drill_HDSS_preloadInit = function(){
	this._drill_HDSS_cacheId = Utils.generateRuntimeId();	//资源缓存id
	this._drill_HDSS_preloadTank = [];						//bitmap容器
	for( var i = 0; i < DrillUp.g_HDSS_layers.length; i++ ){
		var temp_data = DrillUp.g_HDSS_layers[i];
		if( temp_data == undefined ){ continue; }
		if( temp_data['preload'] != true ){ continue; }
		
		this._drill_HDSS_preloadTank.push( 
			ImageManager.reserveBitmap( temp_data['src_img_file'], temp_data['src_img_mask'], 0, true, this._drill_HDSS_cacheId ) 
		);
	}
}
...
//##############################
//DrillUp.g_HDSS_saveEnabled = true;
//##############################
// * 存储数据 - 初始化
//          
//			说明：	> 下方为固定写法，不要动。
//##############################
var _drill_HDSS_sys_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function(){
    _drill_HDSS_sys_initialize.call(this);
	this.drill_HDSS_initSysData();
};
//##############################
// * 存储数据 - 载入存档
//          
//			说明：	> 下方为固定写法，不要动。
//##############################
var _drill_HDSS_sys_extractSaveContents = DataManager.extractSaveContents;
DataManager.extractSaveContents = function( contents ){
	_drill_HDSS_sys_extractSaveContents.call( this, contents );
	
	// > 参数存储 启用时（检查数据）
	if( DrillUp.g_HDSS_saveEnabled == true ){	
		$gameSystem.drill_HDSS_checkSysData();
		
	// > 参数存储 关闭时（直接覆盖）
	}else{
		$gameSystem.drill_HDSS_initSysData();
	}
};
//##############################
// * 存储数据 - 初始化数据【标准函数】
...
//##############################
Game_System.prototype.drill_HDSS_initSysData = function(){
	this.drill_HDSS_initSysData_Private();
};
//##############################
// * 存储数据 - 载入存档时检查数据【标准函数】
//			
...
//##############################
Game_System.prototype.drill_HDSS_checkSysData = function(){
	this.drill_HDSS_checkSysData_Private();
};
//=============================================================================
// ** 存储数据（接口实现）
//=============================================================================
...
// * 存储数据 - 初始化数据（私有）
//==============================
Game_System.prototype.drill_HDSS_initSysData_Private = function(){
	
	this._drill_HDSS_controllerTank = [];	//当前容器（与 g_HDSS_layers 依次对应，容器允许出现null值）
	for(var i = 0; i < DrillUp.g_HDSS_layers.length; i++){
		var temp_data = DrillUp.g_HDSS_layers[i];
		if( temp_data == undefined ){ continue; }
		
		var temp_controller = new Drill_HDSS_Controller( i );
		this._drill_HDSS_controllerTank[i] = temp_controller;
	}
};
//==============================
// * 存储数据 - 载入存档时检查数据（私有）
//==============================
Game_System.prototype.drill_HDSS_checkSysData_Private = function(){
	
	// > 旧存档数据自动补充
	if( this._drill_HDSS_controllerTank == undefined ){
		this.drill_HDSS_initSysData();
	}
	...
	for(var i = 0; i < DrillUp.g_HDSS_layers.length; i++ ){
		...
		// > 未存储的，重新初始化
		if( this._drill_HDSS_controllerTank[i] == undefined ){
			var temp_controller = new Drill_HDSS_Controller( i );
			this._drill_HDSS_controllerTank[i] = temp_controller;
...
// * 控制器与贴图 - 容器初始化
//==============================
var _drill_HDSS_temp_initialize2 = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function(){
	_drill_HDSS_temp_initialize2.call(this);
	this._drill_HDSS_spriteTank = [];			//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
// * 控制器与贴图 - 销毁时（地图界面）
//==============================
var _drill_HDSS_smap_terminate = Scene_Map.prototype.terminate;
Scene_Map.prototype.terminate = function(){
	_drill_HDSS_smap_terminate.call(this);
	$gameTemp._drill_HDSS_spriteTank = [];		//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
// * 控制器与贴图 - 帧刷新（地图界面）
//==============================
var _drill_HDSS_smap_update = Scene_Map.prototype.update;
Scene_Map.prototype.update = function(){
	_drill_HDSS_smap_update.call(this);
	this.drill_HDSS_updateController();		//帧刷新 - 控制器
	this.drill_HDSS_updateAttr();			//帧刷新 - 基础特性
	this.drill_HDSS_updateDestroy();		//帧刷新 - 销毁
};
//==============================
// * 控制器与贴图 - 界面创建时（地图界面）
//==============================
var _drill_HDSS_smap_createAllWindows = Scene_Map.prototype.createAllWindows;
Scene_Map.prototype.createAllWindows = function(){
	_drill_HDSS_smap_createAllWindows.call(this);
	this.drill_HDSS_create();
};
//==============================
// * 控制器与贴图 - 界面创建 （地图界面）
//==============================
Scene_Map.prototype.drill_HDSS_create = function(){
	$gameTemp._drill_HDSS_spriteTank = [];			//贴图容器（不允许出现null值）
	var cur_scene = SceneManager._scene;
	
	for(var i=0; i< $gameSystem._drill_HDSS_controllerTank.length; i++){
		var temp_controller = $gameSystem._drill_HDSS_controllerTank[i];
		if( temp_controller == undefined ){ continue; }
...
// * 控制器与贴图 - 帧刷新 控制器（地图界面）
//==============================
Scene_Map.prototype.drill_HDSS_updateController = function(){
	for(var i = 0; i < $gameSystem._drill_HDSS_controllerTank.length; i++ ){
		var temp_controller = $gameSystem._drill_HDSS_controllerTank[i];
		if( temp_controller == undefined ){ continue; }
...
// * 控制器与贴图 - 帧刷新 基础特性
//==============================
Scene_Map.prototype.drill_HDSS_updateAttr = function(){
	var has_layerChange = false;
	for(var i = 0; i < $gameTemp._drill_HDSS_spriteTank.length; i++){
		var temp_sprite = $gameTemp._drill_HDSS_spriteTank[i];
...
// * 控制器与贴图 - 帧刷新 销毁（地图界面）
//==============================
Scene_Map.prototype.drill_HDSS_updateDestroy = function(){
	
	// > 自动销毁 - 控制器
	for(var i = $gameSystem._drill_HDSS_controllerTank.length-1; i >= 0; i--){
		var temp_controller = $gameSystem._drill_HDSS_controllerTank[i];
		if( temp_controller == undefined ){ continue; }
		if( temp_controller.drill_controller_isDead() ){
			$gameSystem._drill_HDSS_controllerTank.splice(i,1);
		}
	}
	
	// > 自动销毁 - 贴图
	for(var i = $gameTemp._drill_HDSS_spriteTank.length-1; i >= 0; i--){
		var temp_sprite = $gameTemp._drill_HDSS_spriteTank[i];
		if( temp_sprite.drill_sprite_isNeedDestroy() ){
			Graphics.drill_CODS_overstoryLayerRemoveSprite( temp_sprite );	//（销毁贴图）
			$gameTemp._drill_HDSS_spriteTank.splice(i,1);
...
// * 控制器与贴图 - 销毁时（战斗界面）
//==============================
var _drill_HDSS_sbattle_terminate = Scene_Battle.prototype.terminate;
Scene_Battle.prototype.terminate = function(){
	_drill_HDSS_sbattle_terminate.call(this);
	$gameTemp._drill_HDSS_spriteTank = [];		//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
// * 控制器与贴图 - 帧刷新（战斗界面）
//==============================
var _drill_HDSS_sbattle_update = Scene_Battle.prototype.update;
Scene_Battle.prototype.update = function(){
	_drill_HDSS_sbattle_update.call(this);
	this.drill_HDSS_updateController();		//帧刷新 - 控制器
	this.drill_HDSS_updateDestroy();		//帧刷新 - 销毁
};
//==============================
// * 控制器与贴图 - 界面创建时（战斗界面）
//==============================
var _drill_HDSS_sbattle_createAllWindows = Scene_Battle.prototype.createAllWindows;
Scene_Battle.prototype.createAllWindows = function(){
	_drill_HDSS_sbattle_createAllWindows.call(this);
	this.drill_HDSS_create();
};
//==============================
// * 控制器与贴图 - 界面创建 （战斗界面）
//==============================
Scene_Battle.prototype.drill_HDSS_create = Scene_Map.prototype.drill_HDSS_create;
//==============================
// * 控制器与贴图 - 帧刷新 控制器（战斗界面）
//==============================
Scene_Battle.prototype.drill_HDSS_updateController = Scene_Map.prototype.drill_HDSS_updateController;
//==============================
// * 控制器与贴图 - 帧刷新 销毁（战斗界面）
//==============================
Scene_Battle.prototype.drill_HDSS_updateDestroy = Scene_Map.prototype.drill_HDSS_updateDestroy;

//==============================
// * 控制器与贴图 - 销毁时（菜单界面）
//==============================
var _drill_HDSS_smenu_terminate = Scene_MenuBase.prototype.terminate;
Scene_MenuBase.prototype.terminate = function(){
	_drill_HDSS_smenu_terminate.call(this);
	$gameTemp._drill_HDSS_spriteTank = [];		//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
// * 控制器与贴图 - 帧刷新（菜单界面）
//==============================
var _drill_HDSS_smenu_update = Scene_MenuBase.prototype.update;
Scene_MenuBase.prototype.update = function(){
	_drill_HDSS_smenu_update.call(this);
	this.drill_HDSS_updateController();		//帧刷新 - 控制器
	this.drill_HDSS_updateDestroy();		//帧刷新 - 销毁
};
//==============================
// * 控制器与贴图 - 界面创建时（菜单界面）
//==============================
var _drill_HDSS_smenu_createWindowLayer = Scene_MenuBase.prototype.createWindowLayer;
Scene_MenuBase.prototype.createWindowLayer = function(){
	_drill_HDSS_smenu_createWindowLayer.call(this);
	this.drill_HDSS_create();
};
//==============================
// * 控制器与贴图 - 界面创建 （菜单界面）
//==============================
Scene_MenuBase.prototype.drill_HDSS_create = Scene_Map.prototype.drill_HDSS_create;
//==============================
// * 控制器与贴图 - 帧刷新 控制器（菜单界面）
//==============================
Scene_MenuBase.prototype.drill_HDSS_updateController = Scene_Map.prototype.drill_HDSS_updateController;
//==============================
// * 控制器与贴图 - 帧刷新 销毁（菜单界面）
//==============================
Scene_MenuBase.prototype.drill_HDSS_updateDestroy = Scene_Map.prototype.drill_HDSS_updateDestroy;
...
// * 控制器 - 定义
//==============================
function Drill_HDSS_Controller(){
    this.initialize.apply(this, arguments);
};
//==============================
// * 控制器 - 校验标记
//==============================
DrillUp.g_HDSS_checkNaN = true;
//==============================
// * 控制器 - 初始化
//==============================
Drill_HDSS_Controller.prototype.initialize = function( data_id ){
...
//##############################
Drill_HDSS_Controller.prototype.drill_controller_update = function(){
...
//##############################
Drill_HDSS_Controller.prototype.drill_controller_resetData = function( data_id ){
...
//			说明：	> 可放在帧刷新函数中实时调用。
//##############################
Drill_HDSS_Controller.prototype.drill_controller_setVisible = function( visible ){
...
//			说明：	> 可放在帧刷新函数中实时调用。
//##############################
Drill_HDSS_Controller.prototype.drill_controller_setPause = function( pause ){
...
//			返回：	> 布尔
//##############################
Drill_HDSS_Controller.prototype.drill_controller_destroy = function(){
...
//			返回：	> 布尔
//##############################
Drill_HDSS_Controller.prototype.drill_controller_isDead = function(){
...
//			返回：	> 无
//##############################
Drill_HDSS_Controller.prototype.drill_controller_setBlendMode = function( blendMode ){
...
//			返回：	> 无
//##############################
Drill_HDSS_Controller.prototype.drill_controller_setZIndex = function( zIndex ){
...
//##############################
Drill_HDSS_Controller.prototype.drill_controller_initData = function(){
...
// * 初始化 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initChild = function(){
...
// * 控制器 - 重设数据（私有）
//==============================
Drill_HDSS_Controller.prototype.drill_controller_resetData_Private = function( data_id ){
	
	// > 参数检查
	if( typeof data_id != "number" ){
		alert( DrillUp.drill_HDSS_getPluginTip_controllerData_NotId("Drill_HDSS_Controller") );
		throw Error( DrillUp.drill_HDSS_getPluginTip_controllerData_NotId("Drill_HDSS_Controller") );
		return;
	}
...
//##############################
Drill_HDSS_Controller.emptyData = {};
//##############################
// * 控制器 - 获取静态数据【标准函数】
//			
//			参数：	> 无
...
//##############################
Drill_HDSS_Controller.prototype.drill_data = function(){
	var data = DrillUp.g_HDSS_layers[ this._drill_data_id ];
	if( data == undefined ){ return Drill_HDSS_Controller.emptyData; }
	return data;
};
...
// * A主体 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initAttr = function(){
...
// * A主体 - 帧刷新
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateAttr = function(){
...
// * A主体 - 帧刷新 - 校验值
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateCheckNaN = function(){
	if( $gameTemp == undefined ){ return; }		//（测试版开启功能，发布版关闭功能）
	if( $gameTemp.isPlaytest() != true ){ return; }
	
	// > 校验值
	if( DrillUp.g_HDSS_checkNaN == true ){
		if( isNaN( this.drill_controller_finalTransform_x() ) ){
			DrillUp.g_HDSS_checkNaN = false;
			alert( DrillUp.drill_HDSS_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_x" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_y() ) ){
			DrillUp.g_HDSS_checkNaN = false;
			alert( DrillUp.drill_HDSS_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_y" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_opacity() ) ){
			DrillUp.g_HDSS_checkNaN = false;
			alert( DrillUp.drill_HDSS_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_opacity" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_rotate() ) ){
			DrillUp.g_HDSS_checkNaN = false;
			alert( DrillUp.drill_HDSS_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_rotate" ) );
		}
	}
}
...
// * B变换特性 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initChange = function(){
	var data = this.drill_data();
...
// * B变换特性 - 帧刷新 旋转
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateChange_Rotation = function(){
...
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_x = function(){
	return this._drill_change_x;
}
//##############################
// * B变换特性 - 数据最终变换值 - 位置Y（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_y = function(){
	return this._drill_change_y;
}
//##############################
// * B变换特性 - 数据最终变换值 - 缩放X（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_scaleX = function(){
	return this._drill_change_scaleX;
}
//##############################
// * B变换特性 - 数据最终变换值 - 缩放Y（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_scaleY = function(){
	return this._drill_change_scaleY;
}
//##############################
// * B变换特性 - 数据最终变换值 - 透明度（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_opacity = function(){
	return this._drill_change_opacity;
}
//##############################
// * B变换特性 - 数据最终变换值 - 斜切X（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_skewX = function(){
	return this._drill_change_skewX;
}
//##############################
// * B变换特性 - 数据最终变换值 - 斜切Y（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_skewY = function(){
	return this._drill_change_skewY;
}
//##############################
// * B变换特性 - 数据最终变换值 - 旋转（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_rotate = function(){
	return this._drill_change_rotate;
}
//##############################
// * B变换特性 - 数据最终变换值 - 转速（可继承，开放函数）
//##############################
Drill_HDSS_Controller.prototype.drill_controller_finalTransform_rotateSpeed = function(){
...
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initCommandChange = function(){
...
// * D指令叠加变化 - 帧刷新
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateCommandChange = function(){
...
// * D指令叠加变化 - 立即还原所有单属性
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_restoreAttr = function(){
...
// * D指令叠加变化 - 立即归位
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_restoreMove = function(){
	this["_drill_command_move_data"] = undefined;
}
//==============================
// * D指令叠加变化 - 修改单属性 - 移动到
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setMove = function( change_type, tar_valueA, tar_valueB, tar_time ){
	var data = this.drill_data();
...
// * D指令叠加变化 - 修改单属性 - 透明度
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setOpacity = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
...
// * D指令叠加变化 - 修改单属性 - 旋转
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setRotate = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 转速
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setRotateSpeed = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 缩放X
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setScaleX = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 缩放Y
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setScaleY = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 斜切X
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setSkewX = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 斜切Y
//==============================
Drill_HDSS_Controller.prototype.drill_controller_commandChange_setSkewY = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * E延迟指令 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initDelayingCommand = function(){
...
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateDelayingCommandImportant = function(){
...
// * E延迟指令 - 帧刷新 - 执行延迟指令
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateDelayingCommand = function(){
	if( this._drill_curDelayingCommandTank.length == 0 ){ return; }
...
// * E延迟指令 - 设置指令（开放函数）
//==============================
Drill_HDSS_Controller.prototype.drill_controller_setDelayingCommand = function( method, paramList, delay_time ){
	if( method != "drill_controller_setVisible" &&
...
// * E延迟指令 - 清空全部（开放函数）
//==============================
Drill_HDSS_Controller.prototype.drill_controller_clearDelayingCommand = function(){
	this._drill_curDelayingCommandTank = [];
}
...
// * F自变化效果 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initEffect = function(){
	this._drill_curEffectTime = 0;
}
//==============================
// * F自变化效果 - 帧刷新
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updateEffect = function(){
...
// * 动态快照贴图 - 定义
//==============================
function Drill_HDSS_Sprite() {
    this.initialize.apply(this, arguments);
};
Drill_HDSS_Sprite.prototype = Object.create(Sprite.prototype);
Drill_HDSS_Sprite.prototype.constructor = Drill_HDSS_Sprite;
//==============================
// * 动态快照贴图 - 初始化
//==============================
Drill_HDSS_Sprite.prototype.initialize = function(){
...
// * 动态快照贴图 - 帧刷新
//==============================
Drill_HDSS_Sprite.prototype.update = function(){
...
//##############################
Drill_HDSS_Sprite.prototype.drill_sprite_setController = function( controller ){
...
//##############################
Drill_HDSS_Sprite.prototype.drill_sprite_initChild = function(){
...
//			说明：	> 这里完全 不考虑 延迟加载问题。
//##############################
Drill_HDSS_Sprite.prototype.drill_sprite_isReady = function(){
...
//##############################
Drill_HDSS_Sprite.prototype.drill_sprite_isOptimizationPassed = function(){
	if( this._drill_controller._drill_visible == false ){	//（不显示时，不工作）
...
//##############################
Drill_HDSS_Sprite.prototype.drill_sprite_isNeedDestroy = function(){
...
//##############################
Drill_HDSS_Sprite.prototype.drill_sprite_destroy = function(){
...
// * 动态快照贴图 - 贴图初始化（私有）
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initSelf = function(){
...
// * 动态快照贴图 - 销毁子功能（私有）
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_destroyChild = function(){
...
// * 动态快照贴图 - 销毁自身（私有）
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_destroySelf = function(){
	this._drill_controller = null;				//控制器对象
	this._drill_curSerial = -1;					//当前序列号
};
...
// * A主体 - 初始化子功能
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initAttr = function(){
...
// * A主体 - 帧刷新
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_updateAttr = function(){
	...
	//（其它 基础特性 的帧刷新赋值见：drill_HDSS_updateAttr）
}
...
// * B变换特性 - 初始化子功能
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initChange = function(){
	//（无）
}
//==============================
// * B变换特性 - 帧刷新
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_updateChange = function(){
	...
	// > 贴图 - 位置（遮罩）
	if( this._drill_layerSprite.mask != undefined ){
		this._drill_layerSprite.mask.x = -1 * xx;	//（由于遮罩不能套 主体贴图，所以只能进行相反的位移适配）
		this._drill_layerSprite.mask.y = -1 * yy;
	}
...
//					> 参数使用字符串进行控制，默认为 null 值。
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initCommandChange = function(){
...
// * D指令叠加变化-控制器用 - 帧刷新
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_updateCommandChange = function(){
	var data = this._drill_controller.drill_data();
...
// * E延迟指令 - 初始化子功能
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initDelayingCommand = function(){
	//（无）
}
...
// * F自变化效果 - 初始化子功能
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initEffect = function(){
	//（无）
}
//==============================
// * F自变化效果 - 帧刷新
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_updateEffect = function(){
	var data = this._drill_controller.drill_data();
...
//=============================================================================
		...
		Imported.Drill_HtmlDynamicSnapshotSprite = false;
		var pluginTip = DrillUp.drill_HDSS_getPluginTip_NoBasePlugin();
		alert( pluginTip );
}
