...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_SGaB_PluginTip_curName = "Drill_SceneGalleryB.js 面板-全自定义画廊B";
	DrillUp.g_SGaB_PluginTip_baseList = [
	...
	//==============================
	DrillUp.drill_SGaB_getPluginTip_NoBasePlugin = function(){
		if( DrillUp.g_SGaB_PluginTip_baseList.length == 0 ){ return ""; }
		var message = "【" + DrillUp.g_SGaB_PluginTip_curName + "】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对：";
		for(var i=0; i < DrillUp.g_SGaB_PluginTip_baseList.length; i++){
			message += "\n- ";
			message += DrillUp.g_SGaB_PluginTip_baseList[i];
		}
		return message;
	};
...
//=============================================================================
		...
		var pluginTip = DrillUp.drill_SGaB_getPluginTip_NoBasePlugin();
		alert( pluginTip );
}
