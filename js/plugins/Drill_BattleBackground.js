 ...
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 移动速度X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 移动速度Y[1.5] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 移动速度Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 缩放X[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 缩放X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 缩放Y[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 缩放Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 斜切X[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 斜切X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 斜切Y[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性(延迟) : 斜切Y变量%[21] : 时间[60] : 延迟执行时间[20]
 ...
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 移动速度X变量%[21] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 移动速度Y[1.5] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 移动速度Y变量%[21] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 缩放X[1.2] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 缩放X变量%[21] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 缩放Y[1.2] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 缩放Y变量%[21] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 斜切X[0.2] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 斜切X变量%[21] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 斜切Y[0.2] : 时间[60]
 * 插件指令：>战斗背景 : 背景[11] : 修改单属性 : 斜切Y变量%[21] : 时间[60]
 ...
 * -----------------------------------------------------------------------------
 * ----可选设定 - 获取属性
 * 你可以通过插件指令来获取 战斗背景 的属性值：
 * 
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 位置X : 变量[21]
 * 插件指令：>战斗背景 : 背景变量[21] : 获取属性 : 位置X : 变量[21]
 * 
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 位置X : 变量[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 位置Y : 变量[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 透明度 : 变量[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 旋转 : 变量[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 移动速度X : 变量%[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 移动速度Y : 变量%[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 缩放X : 变量%[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 缩放Y : 变量%[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 斜切X : 变量%[21]
 * 插件指令：>战斗背景 : 背景[11] : 获取属性 : 斜切Y : 变量%[21]
 * 
 ...
 * 测试结果：   战斗界面中，平均消耗为：【42.16ms】
 * 
 * 1.插件只在自己作用域下工作消耗性能，在其它作用域下是不工作的。
 *   测试结果并不是精确值，范围在给定值的10ms范围内波动。
 *   更多性能介绍，去看看 "0.性能测试报告 > 关于插件性能.docx"。
 * 2.从原理上来说，多层背景只是固定放置的贴图，但由于在战斗中随时可能
 *   需要变换，所以消耗会稍微多一些。
 *
 * -----------------------------------------------------------------------------
 * ----更新日志
...
//		★性能测试因素	战斗场景-雪地示例
//		★性能测试消耗	2024/6/15：
//							》城镇2背景：9.1ms（drill_sprite_updateCommandChange）6.8ms（drill_sprite_updateChange）
//							》雪地4背景：56.9ms（drill_sprite_updateCommandChange）69.5ms（drill_sprite_updateChange）
//		★最坏情况		暂无
//		★备注			背景如果在不断移动，可能会产生更多的消耗。
//		
//		★优化记录		暂无
//
//<<<<<<<<插件记录<<<<<<<<
...
//=============================================================================
	...
	DrillUp.g_BBa_PluginTip_baseList = ["Drill_CoreOfBallistics.js 数学模型-弹道核心"];
	//==============================
	// * 提示信息 - 报错 - 缺少基础插件
	//			
	...
	// * 提示信息 - 报错 - 底层版本过低
	//==============================
	DrillUp.drill_BBa_getPluginTip_LowVersion = function(){
	...
	// * 提示信息 - 报错 - 控制器的非数字参数
	//==============================
	DrillUp.drill_BBa_getPluginTip_controllerData_NotId = function( class_name ){
...
Game_System.prototype.drill_BBa_createController = function( slot_id, style_id ){
	...
	// > 创建控制器
	var temp_controller = new Drill_BBa_Controller( style_id );
...
Scene_Battle.prototype.update = function(){
	...
	this.drill_BBa_updateAttr();				//帧刷新 - 基础特性
...
Scene_Battle.prototype.drill_BBa_create = function(){
	...
	for(var i=0; i< $gameSystem._drill_BBa_controllerTank.length; i++){
		...
		this.drill_BBa_layerAddSprite( temp_sprite, temp_controller._drill_layerIndex );
	}
...
Scene_Battle.prototype.drill_BBa_updateControllerCamera = function(){
	for(var i = 0; i < $gameSystem._drill_BBa_controllerTank.length; i++ ){
		...
		var pos = this.drill_BBa_layerCameraMoving(xx, yy, temp_controller._drill_layerIndex, option );
		xx = pos.x;
		yy = pos.y;
...
//##############################
Drill_BBa_Controller.prototype.drill_controller_resetData = function( data_id ){
...
//			返回：	> 无
//##############################
Drill_BBa_Controller.prototype.drill_controller_setPer = function( xPer, yPer ){
...
Drill_BBa_Controller.prototype.drill_controller_initData = function(){
	...
	if( data['src_img_file'] == undefined ){ data['src_img_file'] = "img/Battle__layer/" };			//A主体 - 文件夹
...
// * 控制器 - 重设数据（私有）
//==============================
Drill_BBa_Controller.prototype.drill_controller_resetData_Private = function( data_id ){
	
	// > 参数检查
	if( typeof data_id != "number" ){
		alert( DrillUp.drill_BBa_getPluginTip_controllerData_NotId("Drill_BBa_Controller") );
		throw Error( DrillUp.drill_BBa_getPluginTip_controllerData_NotId("Drill_BBa_Controller") );
		return;
	}
...
//##############################
Drill_BBa_Controller.emptyData = {};
//##############################
// * 控制器 - 获取静态数据【标准函数】
//			
//			参数：	> 无
...
//##############################
Drill_BBa_Controller.prototype.drill_data = function(){
	var data = DrillUp.g_BBa_style[ this._drill_data_id ];
	if( data == undefined ){ return Drill_BBa_Controller.emptyData; }
	return data;
};
...
Drill_BBa_Controller.prototype.drill_controller_updateCheckNaN = function(){
	...
	if( DrillUp.g_BBa_checkNaN == true ){
		if( isNaN( this.drill_controller_finalTransform_x() ) ){
			...
			alert( DrillUp.drill_BBa_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_x" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_y() ) ){
			DrillUp.g_BBa_checkNaN = false;
			alert( DrillUp.drill_BBa_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_y" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_opacity() ) ){
			DrillUp.g_BBa_checkNaN = false;
			alert( DrillUp.drill_BBa_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_opacity" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_rotate() ) ){
			DrillUp.g_BBa_checkNaN = false;
			alert( DrillUp.drill_BBa_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_rotate" ) );
		}
	}
}
...
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_x = function(){
	return this._drill_change_x + this._drill_change_selfXAcc + this._drill_move_originOffsetX
		+ this._drill_cameraResultSpriteX;	//（镜头位移结果，见函数 drill_BBa_updateControllerCamera ）
}
//##############################
// * B变换特性 - 数据最终变换值 - 位置Y（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_y = function(){
	return this._drill_change_y + this._drill_change_selfYAcc + this._drill_move_originOffsetY
		+ this._drill_cameraResultSpriteY;	//（镜头位移结果，见函数 drill_BBa_updateControllerCamera ）
}
//##############################
// * B变换特性 - 数据最终变换值 - 移动速度X（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_selfXSpeed = function(){
	return this._drill_change_selfXSpeed;
}
//##############################
// * B变换特性 - 数据最终变换值 - 移动速度Y（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_selfYSpeed = function(){
	return this._drill_change_selfYSpeed;
}
//##############################
// * B变换特性 - 数据最终变换值 - 缩放X（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_scaleX = function(){
	return this._drill_change_scaleX;
}
//##############################
// * B变换特性 - 数据最终变换值 - 缩放Y（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_scaleY = function(){
	return this._drill_change_scaleY;
}
//##############################
// * B变换特性 - 数据最终变换值 - 透明度（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_opacity = function(){
	return this._drill_change_opacity;
}
//##############################
// * B变换特性 - 数据最终变换值 - 斜切X（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_skewX = function(){
	return this._drill_change_skewX;
}
//##############################
// * B变换特性 - 数据最终变换值 - 斜切Y（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_skewY = function(){
	return this._drill_change_skewY;
}
//##############################
// * B变换特性 - 数据最终变换值 - 旋转（可继承，开放函数）
//##############################
Drill_BBa_Controller.prototype.drill_controller_finalTransform_rotate = function(){
...
Drill_BBa_Controller.prototype.drill_controller_updateChange_MoveRange = function(){
	...
	var ww = Graphics.boxWidth;
	var hh = Graphics.boxHeight;
	var rect = $gameTemp.drill_BBa_Math2D_getRectWithTransform(
		0, 0,
		ww, hh,
		0.5, 0.5,
...
//==============================
Game_Temp.prototype.drill_BBa_Math2D_getRectWithTransform = function( 
					rect_x,rect_y,						//矩形位置 
					rect_w,rect_h, 						//矩形宽高 
	...
	// > 变换后的四个点
	var pp1 = $gameTemp.drill_BBa_Math2D_getPointWithTransform( p1_x,p1_y, c_x,c_y, rotation, scale_x,scale_y, skew_x,skew_y );
	var pp2 = $gameTemp.drill_BBa_Math2D_getPointWithTransform( p2_x,p2_y, c_x,c_y, rotation, scale_x,scale_y, skew_x,skew_y );
	var pp3 = $gameTemp.drill_BBa_Math2D_getPointWithTransform( p3_x,p3_y, c_x,c_y, rotation, scale_x,scale_y, skew_x,skew_y );
	var pp4 = $gameTemp.drill_BBa_Math2D_getPointWithTransform( p4_x,p4_y, c_x,c_y, rotation, scale_x,scale_y, skew_x,skew_y );
...
//					  旋转+缩放+斜切 可为负数。
//==============================
Game_Temp.prototype.drill_BBa_Math2D_getPointWithTransform = function( 
					cur_x,cur_y,						//需要变换的点 
...
Drill_BBa_Sprite.prototype.drill_sprite_updateAttr = function(){
	...
	//（其它 基础特性 的帧刷新赋值见：drill_BBa_updateAttr）
}
