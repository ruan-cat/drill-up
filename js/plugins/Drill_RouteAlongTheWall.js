...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_RATW_PluginTip_curName = "Drill_RouteAlongTheWall.js 移动路线-贴墙移动路线";
	DrillUp.g_RATW_PluginTip_baseList = ["Drill_CoreOfMoveRoute.js 移动路线-移动路线核心"];
	//==============================
	// * 提示信息 - 报错 - 缺少基础插件
	//			
	...
	DrillUp.drill_RATW_getPluginTip_NoBasePlugin = function(){
		...
		var message = "【" + DrillUp.g_RATW_PluginTip_curName + "】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对：";
		for(var i=0; i < DrillUp.g_RATW_PluginTip_baseList.length; i++){
			message += "\n- ";
			message += DrillUp.g_RATW_PluginTip_baseList[i];
		}
		return message;
	};
...
//=============================================================================
		...
		var pluginTip = DrillUp.drill_RATW_getPluginTip_NoBasePlugin();
		alert( pluginTip );
}
