...
Game_Actor.prototype.executeFloorDamage = function(){
	...
	// > 计算伤害
    var damage = Math.floor(this.basicFloorDamage() * this.fdr);	//（与地形伤害的倍率叠加）
...
//==============================
// * 地形伤害/地形治愈 - 伤害闪烁效果（开放函数）
//==============================
Game_Actor.prototype.drill_LDF_performMapDamage = function(){
	this.performMapDamage();								//（红色闪烁）
};
//==============================
// * 地形伤害/地形治愈 - 治愈闪烁效果（开放函数）
//==============================
...
Game_Actor.prototype.executeFloorDamage = function(){
	...
	if( damage > 0 ){
		...
		this.gainHp(-1 * dv);
		if( dv > 0 ){
			this.drill_LDF_performMapDamage();
		}
