 ...
 *   (2."战斗开始时执行"将在进入战斗对话框显示"xxx出现"后，执行。
 *      如果你去掉了"xxx出现"的对话框，那么直接执行。
 *   (3."战斗结束时执行"将在战斗结束前执行，
 *      执行期间可以阻塞流程，执行完后进入战斗结算。
 * 细节：
 *   (1.该插件对所有战斗都有效，如果你要对指定的哪一次战斗进行配置。
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_BEE_PluginTip_curName = "Drill_BattleEventExtend.js 公共事件-战斗开始结束时";
	DrillUp.g_BEE_PluginTip_baseList = [];
