//=============================================================================
// Drill_SceneSelfplateM.js
//=============================================================================

/*:
 * @plugindesc [v1.4]        面板 - 全自定义信息面板M
 * @author Drill_up
 * 
 * @Drill_LE_param "内容-%d"
 * @Drill_LE_parentKey "---内容组%d至%d---"
 * @Drill_LE_var "DrillUp.g_SSpM_context_list_length"
 * 
 *
 * @help
 * =============================================================================
 * +++ Drill_SceneSelfplateM +++
 * 作者：Drill_up
 ...
 *
 * 资源-整体布局           （默认为 信息面板M-整体布局）
 * 资源-锁定的描述图       （默认为 信息面板M-锁定描述图）
 ...
 * 插件指令：>信息面板M : 打开面板
 *
 * 插件指令：>信息面板M : 显示选项 : 选项[1]
 * 插件指令：>信息面板M : 显示选项 : 选项变量[21]
 * 插件指令：>信息面板M : 隐藏选项 : 选项[1]
 * 插件指令：>信息面板M : 隐藏选项 : 选项变量[21]
 * 插件指令：>信息面板M : 显示全部选项
 * 插件指令：>信息面板M : 隐藏全部选项
 * 
 * 插件指令：>信息面板M : 锁定选项 : 选项[1]
 * 插件指令：>信息面板M : 锁定选项 : 选项变量[21]
 * 插件指令：>信息面板M : 解锁选项 : 选项[1]
 * 插件指令：>信息面板M : 解锁选项 : 选项变量[21]
 * 插件指令：>信息面板M : 锁定全部选项
 * 插件指令：>信息面板M : 解锁全部选项
 *
 ...
 * 
 * 插件指令：>信息面板M : 选中选项 : 选项[1]
 * 插件指令：>信息面板M : 选中选项 : 选项变量[21]
 * 
 ...
 * @default {"平移-按钮组 X":"80","平移-按钮组 Y":"30","按钮组样式":"5","---按钮贴图---":"","默认按钮贴图":"信息面板M-默认按钮","按钮贴图序列":"[]"}
 * 
 * @param 选项窗口
 * @parent ----选项----
 * @desc 选项模式为 窗口模式 时，选项窗口的配置数据。
 * @type struct<DrillSelectWindow>
 * @default {"选项窗口 X":"48","选项窗口 Y":"140","选项窗口宽度":"220","选项窗口高度":"360","选项窗口列数":"1","每条选项高度":"36","是否启用选项内容":"false","选项窗口对齐方式":"左对齐","选项窗口字体大小":"22","选项窗口移动动画":"{\"移动类型\":\"弹性移动\",\"移动时长\":\"30\",\"移动延迟\":\"0\",\"---起点---\":\"\",\"坐标类型\":\"相对坐标\",\"起点-相对坐标 X\":\"-100\",\"起点-相对坐标 Y\":\"0\",\"起点-绝对坐标 X\":\"0\",\"起点-绝对坐标 Y\":\"0\"}","选项窗口布局":"{\"布局类型\":\"隐藏布局\",\"---单张背景贴图---\":\"\",\"资源-贴图\":\"信息面板M-选项窗口\",\"贴图位置修正 X\":\"0\",\"贴图位置修正 Y\":\"0\"}","选项窗口指针与边框":"{}"}
 *
 *
 * @param ----描述窗口----
 * @default 
 ...
 * @default {"描述窗口 X":"285","描述窗口 Y":"140","描述窗口宽度":"100","描述窗口高度":"360","描述窗口字体大小":"22","描述窗口移动动画":"{\"移动类型\":\"弹性移动\",\"移动时长\":\"30\",\"移动延迟\":\"0\",\"---起点---\":\"\",\"坐标类型\":\"相对坐标\",\"起点-相对坐标 X\":\"0\",\"起点-相对坐标 Y\":\"-100\",\"起点-绝对坐标 X\":\"0\",\"起点-绝对坐标 Y\":\"0\"}","描述窗口布局":"{\"布局类型\":\"隐藏布局\",\"---单张背景贴图---\":\"\",\"资源-贴图\":\"信息面板M-描述窗口\",\"贴图位置修正 X\":\"0\",\"贴图位置修正 Y\":\"0\"}","是否重播描述窗口移动动画":"true"}
 * 
 * @param 描述窗口-2
 * @parent ----描述窗口----
 * @desc 第二个描述窗口。
 * @type struct<DrillDescWindow>
 * @default {"描述窗口 X":"395","描述窗口 Y":"140","描述窗口宽度":"100","描述窗口高度":"360","描述窗口字体大小":"22","描述窗口移动动画":"{\"移动类型\":\"弹性移动\",\"移动时长\":\"30\",\"移动延迟\":\"10\",\"---起点---\":\"\",\"坐标类型\":\"相对坐标\",\"起点-相对坐标 X\":\"0\",\"起点-相对坐标 Y\":\"-100\",\"起点-绝对坐标 X\":\"0\",\"起点-绝对坐标 Y\":\"0\"}","描述窗口布局":"{\"布局类型\":\"隐藏布局\",\"---单张背景贴图---\":\"\",\"资源-贴图\":\"信息面板M-描述窗口\",\"贴图位置修正 X\":\"0\",\"贴图位置修正 Y\":\"0\"}","是否重播描述窗口移动动画":"true"}
 * 
 * @param 描述窗口-3
 * @parent ----描述窗口----
 * @desc 第三个描述窗口。
 * @type struct<DrillDescWindow>
 * @default {"描述窗口 X":"505","描述窗口 Y":"140","描述窗口宽度":"100","描述窗口高度":"360","描述窗口字体大小":"22","描述窗口移动动画":"{\"移动类型\":\"弹性移动\",\"移动时长\":\"30\",\"移动延迟\":\"20\",\"---起点---\":\"\",\"坐标类型\":\"相对坐标\",\"起点-相对坐标 X\":\"0\",\"起点-相对坐标 Y\":\"-100\",\"起点-绝对坐标 X\":\"0\",\"起点-绝对坐标 Y\":\"0\"}","描述窗口布局":"{\"布局类型\":\"隐藏布局\",\"---单张背景贴图---\":\"\",\"资源-贴图\":\"信息面板M-描述窗口\",\"贴图位置修正 X\":\"0\",\"贴图位置修正 Y\":\"0\"}","是否重播描述窗口移动动画":"true"}
 * 
 * @param 描述窗口-4
 * @parent ----描述窗口----
 * @desc 第四个描述窗口。
 * @type struct<DrillDescWindow>
 * @default {"描述窗口 X":"615","描述窗口 Y":"140","描述窗口宽度":"100","描述窗口高度":"360","描述窗口字体大小":"22","描述窗口移动动画":"{\"移动类型\":\"弹性移动\",\"移动时长\":\"30\",\"移动延迟\":\"30\",\"---起点---\":\"\",\"坐标类型\":\"相对坐标\",\"起点-相对坐标 X\":\"0\",\"起点-相对坐标 Y\":\"-100\",\"起点-绝对坐标 X\":\"0\",\"起点-绝对坐标 Y\":\"0\"}","描述窗口布局":"{\"布局类型\":\"隐藏布局\",\"---单张背景贴图---\":\"\",\"资源-贴图\":\"信息面板M-描述窗口\",\"贴图位置修正 X\":\"0\",\"贴图位置修正 Y\":\"0\"}","是否重播描述窗口移动动画":"true"}
 *
 *
 * @param ----描述图----
 * @default 
 ...
 * @desc 控制窗口框架与窗口背景。
 * @default {"布局类型":"单张背景贴图","---单张背景贴图---":"","资源-贴图":"信息面板M-选项窗口","贴图位置修正 X":"0","贴图位置修正 Y":"0"}
 * 
 * @param 选项窗口指针与边框
 ...
 * @type struct<DrillWindowLayout>
 * @desc 控制窗口框架与窗口背景。
 * @default {"布局类型":"单张背景贴图","---单张背景贴图---":"","资源-贴图":"信息面板M-描述窗口","贴图位置修正 X":"0","贴图位置修正 Y":"0"}
 * 
 * @param 是否重播描述窗口移动动画
 * @type boolean
 * @on 重播
...
//			->☆面板控制
//			
//			->信息面板M【Scene_Drill_SSpM】
//				->详细窗口（x4）
//				->描述图片（x4）
//				->☆原型链规范（Scene_Drill_SSpM）
//			->选项窗口【Drill_SSpM_SelectWindow】
//			->显示窗口【Drill_SSpM_DescWindow】
//			
//			
//		★家谱：
//			无
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_SSpM_PluginTip_curName = "Drill_SceneSelfplateM.js 面板-全自定义信息面板M";
	DrillUp.g_SSpM_PluginTip_baseList = [
	...
	//==============================
	DrillUp.drill_SSpM_getPluginTip_NoBasePlugin = function(){
		if( DrillUp.g_SSpM_PluginTip_baseList.length == 0 ){ return ""; }
		var message = "【" + DrillUp.g_SSpM_PluginTip_curName + "】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对：";
		for(var i=0; i < DrillUp.g_SSpM_PluginTip_baseList.length; i++){
			message += "\n- ";
			message += DrillUp.g_SSpM_PluginTip_baseList[i];
		}
		return message;
	};
...
　　Imported.Drill_SceneSelfplateM = true;
　　var DrillUp = DrillUp || {}; 
    DrillUp.parameters = PluginManager.parameters('Drill_SceneSelfplateM');
	...
	//				（~struct~DrillCursor）
	//==============================
	DrillUp.drill_SSpM_initMenuCursor = function( dataFrom ) {
		var data = {};
	...
	//				（~struct~DrillSelectWindow）
	//==============================
	DrillUp.drill_SSpM_initCommandWindow = function( dataFrom ) {
		var data = {};
		...
		if( dataFrom["选项窗口指针与边框"] != "" &&
			...
			data['cursor'] = DrillUp.drill_SSpM_initMenuCursor( cursor );
		}else{
			data['cursor'] = DrillUp.drill_SSpM_initMenuCursor( {} );
		}
		return data;
	}
	//==============================
	...
	//				（~struct~DrillCommandButton）
	//==============================
	DrillUp.drill_SSpM_initCommandButton = function( dataFrom ) {
		var data = {};
	...
	//				（~struct~DrillDescWindow）
	//==============================
	DrillUp.drill_SSpM_initDescWindow = function( dataFrom ) {
		var data = {};
	...
	//				（~struct~DrillDescPic）
	//==============================
	DrillUp.drill_SSpM_initDescPic = function( dataFrom ) {
		var data = {};
	...
	//				（~struct~DrillSSpM）
	//==============================
	DrillUp.drill_SSpM_initContext = function( dataFrom ) {
		var data = {};
	...
	/*-----------------杂项------------------*/
    DrillUp.g_SSpM_layout = String(DrillUp.parameters['资源-整体布局'] || "");
	DrillUp.g_SSpM_add_to_menu = String(DrillUp.parameters['是否添加到主菜单'] || "true") === "true";	
    DrillUp.g_SSpM_menu_name = String(DrillUp.parameters['主菜单显示名'] || "");
	DrillUp.g_SSpM_add_to_title = String(DrillUp.parameters['是否在标题窗口中显示'] || "false") === "true";	
    DrillUp.g_SSpM_title_name = String(DrillUp.parameters['标题窗口显示名'] || "");
	DrillUp.g_SSpM_title_data_global = String(DrillUp.parameters['数据是否全局存储'] || "false") === "true";	
    DrillUp.g_SSpM_title_data_fileId = Number(DrillUp.parameters['全局存储的文件路径'] || 1);	
	
	/*-----------------选项------------------*/
	DrillUp.g_SSpM_command_mode = String(DrillUp.parameters["选项模式"] || "按钮组模式");
	if( DrillUp.parameters["选项窗口"] != undefined &&
		DrillUp.parameters["选项窗口"] != "" ){
		var data = JSON.parse( DrillUp.parameters["选项窗口"] );
		DrillUp.g_SSpM_command_window = DrillUp.drill_SSpM_initCommandWindow( data );
	}else{
		DrillUp.g_SSpM_command_window = DrillUp.drill_SSpM_initCommandWindow( {} );
	}
	if( DrillUp.parameters["选项按钮组"] != undefined &&
		DrillUp.parameters["选项按钮组"] != "" ){
		var data = JSON.parse( DrillUp.parameters["选项按钮组"] );
		DrillUp.g_SSpM_command_button = DrillUp.drill_SSpM_initCommandButton( data );
	}else{
		DrillUp.g_SSpM_command_button = DrillUp.drill_SSpM_initCommandButton( {} );
	}
	...
	if( DrillUp.parameters["描述窗口-1"] != undefined &&
		...
		DrillUp.g_SSpM_desc_1 = DrillUp.drill_SSpM_initDescWindow( data );
	}else{
		DrillUp.g_SSpM_desc_1 = DrillUp.drill_SSpM_initDescWindow( {} );
	}
	if( DrillUp.parameters["描述窗口-2"] != undefined &&
		DrillUp.parameters["描述窗口-2"] != "" ){
		var data = JSON.parse( DrillUp.parameters["描述窗口-2"] );
		DrillUp.g_SSpM_desc_2 = DrillUp.drill_SSpM_initDescWindow( data );
	}else{
		DrillUp.g_SSpM_desc_2 = DrillUp.drill_SSpM_initDescWindow( {} );
	}
	if( DrillUp.parameters["描述窗口-3"] != undefined &&
		DrillUp.parameters["描述窗口-3"] != "" ){
		var data = JSON.parse( DrillUp.parameters["描述窗口-3"] );
		DrillUp.g_SSpM_desc_3 = DrillUp.drill_SSpM_initDescWindow( data );
	}else{
		DrillUp.g_SSpM_desc_3 = DrillUp.drill_SSpM_initDescWindow( {} );
	}
	if( DrillUp.parameters["描述窗口-4"] != undefined &&
		DrillUp.parameters["描述窗口-4"] != "" ){
		var data = JSON.parse( DrillUp.parameters["描述窗口-4"] );
		DrillUp.g_SSpM_desc_4 = DrillUp.drill_SSpM_initDescWindow( data );
	}else{
		DrillUp.g_SSpM_desc_4 = DrillUp.drill_SSpM_initDescWindow( {} );
	}
	...
	if( DrillUp.parameters["描述图-1"] != undefined &&
		...
		DrillUp.g_SSpM_descPic_1 = DrillUp.drill_SSpM_initDescPic( data );
	}else{
		DrillUp.g_SSpM_descPic_1 = DrillUp.drill_SSpM_initDescPic( {} );
	}
	if( DrillUp.parameters["描述图-2"] != undefined &&
		DrillUp.parameters["描述图-2"] != "" ){
		var data = JSON.parse( DrillUp.parameters["描述图-2"] );
		DrillUp.g_SSpM_descPic_2 = DrillUp.drill_SSpM_initDescPic( data );
	}else{
		DrillUp.g_SSpM_descPic_2 = DrillUp.drill_SSpM_initDescPic( {} );
	}
	if( DrillUp.parameters["描述图-3"] != undefined &&
		DrillUp.parameters["描述图-3"] != "" ){
		var data = JSON.parse( DrillUp.parameters["描述图-3"] );
		DrillUp.g_SSpM_descPic_3 = DrillUp.drill_SSpM_initDescPic( data );
	}else{
		DrillUp.g_SSpM_descPic_3 = DrillUp.drill_SSpM_initDescPic( {} );
	}
	if( DrillUp.parameters["描述图-4"] != undefined &&
		DrillUp.parameters["描述图-4"] != "" ){
		var data = JSON.parse( DrillUp.parameters["描述图-4"] );
		DrillUp.g_SSpM_descPic_4 = DrillUp.drill_SSpM_initDescPic( data );
	}else{
		DrillUp.g_SSpM_descPic_4 = DrillUp.drill_SSpM_initDescPic( {} );
	}
	
	/*-----------------内容------------------*/
	DrillUp.g_SSpM_context_list_length = 80;
	DrillUp.g_SSpM_context_list = [];
	for( var i = 1; i <= DrillUp.g_SSpM_context_list_length ; i++ ){
		if( DrillUp.parameters['内容-' + String(i) ] != "" ){
			...
			DrillUp.g_SSpM_context_list[i] = DrillUp.drill_SSpM_initContext( data );
			DrillUp.g_SSpM_context_list[i]['index'] = i;
		}else{
			DrillUp.g_SSpM_context_list[i] = null;
		}
	};
	
	/*-----------------锁定内容------------------*/
	DrillUp.g_SSpM_locked_name = String(DrillUp.parameters['用语-锁定的选项名'] || "");
	DrillUp.g_SSpM_locked_name = DrillUp.g_SSpM_locked_name.replace(/\\\\/g,"\\");
	DrillUp.g_SSpM_locked_context = String(DrillUp.parameters['用语-锁定的选项内容'] || "");
	DrillUp.g_SSpM_locked_context = DrillUp.g_SSpM_locked_context.substring(1,DrillUp.g_SSpM_locked_context.length-1);
	DrillUp.g_SSpM_locked_context = DrillUp.g_SSpM_locked_context.replace(/\\\\/g,"\\");
	DrillUp.g_SSpM_locked_context = DrillUp.g_SSpM_locked_context.split(/\\n/);
	...
	/*-----------------全局存储对象------------------*/
	DrillUp.global_SSpM_enableTank = null;
	DrillUp.global_SSpM_lockTank = null;
...
// * 全局 - 检查数据 - 显示情况
//==============================
DrillUp.drill_SSpM_gCheckData_enable = function(){
	for( var i = 1; i <= DrillUp.g_SSpM_context_list_length ; i++ ){
		var temp_c = DrillUp.g_SSpM_context_list[i];
		
		// > 指定数据为空时
		if( DrillUp.global_SSpM_enableTank[i] == null ){
			if( temp_c == null ){		//（无内容配置，跳过）
				DrillUp.global_SSpM_enableTank[i] = null;
			}else{						//（有内容配置，初始化默认）
				DrillUp.global_SSpM_enableTank[i] = temp_c['enabled'];
			}
...
// * 全局 - 检查数据 - 锁定情况
//==============================
DrillUp.drill_SSpM_gCheckData_lock = function(){
	for( var i = 1; i <= DrillUp.g_SSpM_context_list_length ; i++ ){
		var temp_c = DrillUp.g_SSpM_context_list[i];
		
		// > 指定数据为空时
		if( DrillUp.global_SSpM_lockTank[i] == null ){
			if( temp_c == null ){		//（无内容配置，跳过）
				DrillUp.global_SSpM_lockTank[i] = null;
			}else{						//（有内容配置，初始化默认）
				DrillUp.global_SSpM_lockTank[i] = temp_c['locked'];
			}
...
// * 全局 - 读取
//==============================
	var global_fileId = DrillUp.g_SSpM_title_data_fileId;
	var global_data = StorageManager.drill_COGS_loadData( global_fileId, "SSpM" );
	
	// > 显示情况
	if( DrillUp.global_SSpM_enableTank == null ){			//（游戏没关时，不会为null)
		var data = global_data["global_enableTank"];
		if( data == undefined ){ data = [] };
		DrillUp.global_SSpM_enableTank = data;
		DrillUp.drill_SSpM_gCheckData_enable();				//（检查时自动赋新值）
	}
	// > 锁定情况
	if( DrillUp.global_SSpM_lockTank == null ){	
		var data = global_data["global_lockTank"];
		if( data == undefined ){ data = [] };
		DrillUp.global_SSpM_lockTank = data;
		DrillUp.drill_SSpM_gCheckData_lock();
	}
	
//==============================
// * 全局 - 存储
//==============================
StorageManager.drill_SSpM_saveData = function(){
	var file_id = DrillUp.g_SSpM_title_data_fileId;
	var data = {};
	data["global_enableTank"] = DrillUp.global_SSpM_enableTank;
	data["global_lockTank"] = DrillUp.global_SSpM_lockTank;
	this.drill_COGS_saveData( file_id, "SSpM", data );
};
...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	...
	if( command === ">信息面板M" ){
		...
		if(args.length == 2){
			...
			if( type == "打开面板" ){			//打开菜单
				SceneManager.push(Scene_Drill_SSpM);
			}
			if( type == "显示全部选项" || type == "显示全部" ){
				for( var i = 1; i <= DrillUp.g_SSpM_context_list_length; i++){
					DrillUp.global_SSpM_enableTank[i] = true;			//全局存储
					$gameSystem._drill_SSpM_enableTank[i] = true;		//正常存储
				}
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "隐藏全部选项" || type == "隐藏全部" ){
				for( var i = 1; i <= DrillUp.g_SSpM_context_list_length; i++){
					DrillUp.global_SSpM_enableTank[i] = false;			//全局存储
					$gameSystem._drill_SSpM_enableTank[i] = false;		//正常存储
				}
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "锁定全部选项" || type == "锁定全部" ){
				for( var i = 1; i <= DrillUp.g_SSpM_context_list_length; i++){
					DrillUp.global_SSpM_lockTank[i] = true;				//全局存储
					$gameSystem._drill_SSpM_lockTank[i] = true;			//正常存储
				}
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "解锁全部选项" || type == "解锁全部" ){
				for( var i = 1; i <= DrillUp.g_SSpM_context_list_length; i++){
					DrillUp.global_SSpM_lockTank[i] = false;			//全局存储
					$gameSystem._drill_SSpM_lockTank[i] = false;		//正常存储
				}
				StorageManager.drill_SSpM_saveData();
			}
		}
		...
		if(args.length == 4){
			...
			if( type == "显示选项" ){
				DrillUp.global_SSpM_enableTank[ Number(temp1) ] = true;			//全局存储
				$gameSystem._drill_SSpM_enableTank[ Number(temp1) ] = true;		//正常存储
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "隐藏选项" ){
				DrillUp.global_SSpM_enableTank[ Number(temp1) ] = false;		//全局存储
				$gameSystem._drill_SSpM_enableTank[ Number(temp1) ] = false;	//正常存储
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "锁定选项" ){
				DrillUp.global_SSpM_lockTank[ Number(temp1) ] = true;			//全局存储
				$gameSystem._drill_SSpM_lockTank[ Number(temp1) ] = true;		//正常存储
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "解锁选项" ){
				DrillUp.global_SSpM_lockTank[ Number(temp1) ] = false;			//全局存储
				$gameSystem._drill_SSpM_lockTank[ Number(temp1) ] = false;		//正常存储
				StorageManager.drill_SSpM_saveData();
			}
			if( type == "选中选项" || type == "选中页" ){
				$gameSystem._drill_SSpM_context_index = Number(temp1) -1;
			}
		}
	}
...
// ** ☆主菜单选项
//
//			说明：	> 此模块专门关联主菜单选项，选项进入后跳转到 信息面板M 界面。
//					（插件完整的功能目录去看看：功能结构树）
//=============================================================================
var _drill_SSpM_createCommandWindow = Scene_Menu.prototype.createCommandWindow;
Scene_Menu.prototype.createCommandWindow = function() {
	_drill_SSpM_createCommandWindow.call(this);
    this._commandWindow.setHandler('Drill_SSpM',   this.drill_SSpM_menuCommand.bind(this));
};
Scene_Menu.prototype.drill_SSpM_menuCommand = function() {
    SceneManager.push(Scene_Drill_SSpM);
};
var _drill_SSpM_addOriginalCommands = Window_MenuCommand.prototype.addOriginalCommands;
Window_MenuCommand.prototype.addOriginalCommands = function() {
	_drill_SSpM_addOriginalCommands.call(this);
	if( DrillUp.g_SSpM_add_to_menu ){
		this.addCommand(DrillUp.g_SSpM_menu_name, 'Drill_SSpM', this.areMainCommandsEnabled());
	}
};
...
// ** ☆标题选项
//
//			说明：	> 此模块专门关联标题选项，选项进入后跳转到 信息面板M 界面。
//					（插件完整的功能目录去看看：功能结构树）
//=============================================================================	
var _drill_SSpM_title_createCommandWindow = Scene_Title.prototype.createCommandWindow;
Scene_Title.prototype.createCommandWindow = function() {
    _drill_SSpM_title_createCommandWindow.call(this);
	this._commandWindow.setHandler('Drill_SSpM',  this.drill_SSpM_titleCommand.bind(this));
};
Scene_Title.prototype.drill_SSpM_titleCommand = function() {
    this._commandWindow.close();
    SceneManager.push(Scene_Drill_SSpM);
};
var _drill_SSpM_title_makeCommandList = Window_TitleCommand.prototype.makeCommandList;
Window_TitleCommand.prototype.makeCommandList = function() {
    _drill_SSpM_title_makeCommandList.call(this);
	if( DrillUp.g_SSpM_add_to_title ){
		this.addCommand( DrillUp.g_SSpM_title_name ,'Drill_SSpM');
	}
};	
...
// * 面板控制 - 初始化
//==============================
var _drill_SSpM_temp_initialize = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function() {	
	_drill_SSpM_temp_initialize.call(this);
	this._drill_SSpM_visibleList = [];			//可见的列表
};
//==============================
// * 面板控制 - 判断 锁定情况
//==============================
Game_Temp.prototype.drill_SSpM_isLocked = function( context_realIndex ){
	...
	// > 全局存储控制
	if( DrillUp.g_SSpM_title_data_global == true ){
		if( DrillUp.global_SSpM_lockTank[ context_realIndex ] == true ){
			return true;
		}else{
			return false;
		}
	...
	// > 正常存储控制
		...
		if( $gameSystem._drill_SSpM_lockTank[ context_realIndex ] == true ){
			return true;
		}else{
			return false;
		}
...
Game_Temp.prototype.drill_SSpM_isEnabled = function( context_realIndex ){
	...
	// > 全局存储控制
	if( DrillUp.g_SSpM_title_data_global == true ){
		if( DrillUp.global_SSpM_enableTank[ context_realIndex ] == true ){
			return true;
		}else{
			return false;
		}
	...
	// > 正常存储控制
		...
		if( $gameSystem._drill_SSpM_enableTank[ context_realIndex ] == true ){
			return true;
		}else{
			return false;
		}
...
//			主要成员：
//						> ._window_select						选项窗口
//						> ._drill_SSpM_commandButtonSprite		按钮组贴图
//						> ._window_desc_1						描述窗口
//						> ._window_desc_2						描述窗口
//						> ._window_desc_3						描述窗口
//						> ._window_desc_4						描述窗口
...
// * 信息面板M - 定义
//==============================
function Scene_Drill_SSpM() {
    this.initialize.apply(this, arguments);
}
Scene_Drill_SSpM.prototype = Object.create(Scene_MenuBase.prototype);
Scene_Drill_SSpM.prototype.constructor = Scene_Drill_SSpM;
//==============================
// * 信息面板M - 初始化
//==============================
...
// * 信息面板M - 创建
//============================== 
Scene_Drill_SSpM.prototype.create = function() {
...
// * 信息面板M - 帧刷新
//==============================
Scene_Drill_SSpM.prototype.update = function() { 
	Scene_MenuBase.prototype.update.call(this);	
	
	// > 选项
	if( DrillUp.g_SSpM_command_mode == "按钮组模式" ){
		this._window_select.y = Graphics.boxHeight * 2;
	}
	if( DrillUp.g_SSpM_command_mode == "窗口模式" ){
...
// * 创建 - 整体布局
//==============================
Scene_Drill_SSpM.prototype.drill_createLayout = function() {
	this._drill_layout = new Sprite(ImageManager.load_MenuSelfDef(DrillUp.g_SSpM_layout));
	this._drill_field.addChild(this._drill_layout);	
};
//==============================
// * 创建 - 选项窗口
//==============================
Scene_Drill_SSpM.prototype.drill_createSelect = function() {
	var data = DrillUp.g_SSpM_command_window;	//（直接读取选项窗口中的项）
	
	this._window_select = new Drill_SSpM_SelectWindow(0, 0, 0, 0);
...
// * 创建 - 选项按钮组
//==============================
Scene_Drill_SSpM.prototype.drill_createCommandButton = function() {
	if( DrillUp.g_SSpM_command_mode != "按钮组模式" ){ return; }
	
	// > 准备按钮组参数
	var data_org = DrillUp.g_SSpM_command_button;
	...
	this._drill_SSpM_commandButtonSprite = temp_sprite;
};
//==============================
// * 创建 - 描述窗口（x4）
//==============================
Scene_Drill_SSpM.prototype.drill_createDesc = function() {
	
	this._window_desc_1 = new Drill_SSpM_DescWindow(0, 0, 0, 0,  1);
	this._window_desc_1.drill_COWA_changeParamData( DrillUp.g_SSpM_desc_1 );		//辅助核心 - 控制窗口基本属性
	this._window_desc_2 = new Drill_SSpM_DescWindow(0, 0, 0, 0,  2);
	this._window_desc_2.drill_COWA_changeParamData( DrillUp.g_SSpM_desc_2 );
	this._window_desc_3 = new Drill_SSpM_DescWindow(0, 0, 0, 0,  3);
	this._window_desc_3.drill_COWA_changeParamData( DrillUp.g_SSpM_desc_3 );
	this._window_desc_4 = new Drill_SSpM_DescWindow(0, 0, 0, 0,  4);
	this._window_desc_4.drill_COWA_changeParamData( DrillUp.g_SSpM_desc_4 );
...
// * 创建 - 描述图片（x4）
//==============================
Scene_Drill_SSpM.prototype.drill_createDescPic = function() {

	this._sprite_descPic_1 = new Sprite();
	this._sprite_descPic_1.drill_COWA_setButtonMove( DrillUp.g_SSpM_descPic_1 );		//辅助核心 - 控制按钮贴图基本属性
	this._sprite_descPic_2 = new Sprite();
	this._sprite_descPic_2.drill_COWA_setButtonMove( DrillUp.g_SSpM_descPic_2 );
	this._sprite_descPic_3 = new Sprite();
	this._sprite_descPic_3.drill_COWA_setButtonMove( DrillUp.g_SSpM_descPic_3 );
	this._sprite_descPic_4 = new Sprite();
	this._sprite_descPic_4.drill_COWA_setButtonMove( DrillUp.g_SSpM_descPic_4 );
...
// * 信息面板M - 描述图片刷新（x4）
//==============================
Scene_Drill_SSpM.prototype.drill_refreshDescPic = function( cur_index ) {
	var temp_list = $gameTemp._drill_SSpM_visibleList;		//可见项列表
	...
	if( src_tank_1.length == 0 ){
		...
		for( var i=0; i < temp_list.length; i++ ){
			...
			src_tank_1[ i+1 ] = ImageManager.load_MenuSelfDef(DrillUp.g_SSpM_context_list[context_index]["pic_1"]);	
		}
	...
	if( src_tank_2.length == 0 ){
		...
		for( var i=0; i < temp_list.length; i++ ){
			var context_index = temp_list[i]['index'];
			src_tank_2[ i+1 ] = ImageManager.load_MenuSelfDef(DrillUp.g_SSpM_context_list[context_index]["pic_2"]);	
		}
	...
	if( DrillUp.g_SSpM_descPic_2['showInstant'] == false ){
	...
	if( src_tank_3.length == 0 ){
		...
		for( var i=0; i < temp_list.length; i++ ){
			var context_index = temp_list[i]['index'];
			src_tank_3[ i+1 ] = ImageManager.load_MenuSelfDef(DrillUp.g_SSpM_context_list[context_index]["pic_3"]);	
		}
	...
	if( DrillUp.g_SSpM_descPic_3['showInstant'] == false ){
	...
	if( src_tank_4.length == 0 ){
		...
		for( var i=0; i < temp_list.length; i++ ){
			var context_index = temp_list[i]['index'];
			src_tank_4[ i+1 ] = ImageManager.load_MenuSelfDef(DrillUp.g_SSpM_context_list[context_index]["pic_4"]);	
		}
	...
	if( DrillUp.g_SSpM_descPic_4['showInstant'] == false ){
...
// * 帧刷新 - 描述图片（x4）
//==============================
Scene_Drill_SSpM.prototype.drill_updateDescPic = function() {
	if( DrillUp.g_SSpM_descPic_1['showInstant'] == false ){
		this._sprite_descPic_1.opacity += 255/DrillUp.g_SSpM_descPic_1['slideTime'];
	}
	if( DrillUp.g_SSpM_descPic_2['showInstant'] == false ){
		this._sprite_descPic_2.opacity += 255/DrillUp.g_SSpM_descPic_2['slideTime'];
	}
	if( DrillUp.g_SSpM_descPic_3['showInstant'] == false ){
		this._sprite_descPic_3.opacity += 255/DrillUp.g_SSpM_descPic_3['slideTime'];
	}
	if( DrillUp.g_SSpM_descPic_4['showInstant'] == false ){
		this._sprite_descPic_4.opacity += 255/DrillUp.g_SSpM_descPic_4['slideTime'];
	}
}
//==============================
// * 帧刷新 - 窗口选项刷新（x4）
//==============================
Scene_Drill_SSpM.prototype.drill_updateIndex = function() {
	if( $gameSystem._drill_SSpM_context_index != undefined ){
		var temp = $gameSystem._drill_SSpM_context_index;
		$gameSystem._drill_SSpM_context_index = null;	//（激活后清空）
		if( temp < 0 ){ temp = 0; };
		if( temp > $gameTemp._drill_SSpM_visibleList.length -1 ){ temp = $gameTemp._drill_SSpM_visibleList.length -1; };
		this._window_select.select( temp );				//（设置选中选项）
	}
	if( this._window_select._index == null || 
		this._window_select._index > $gameTemp._drill_SSpM_visibleList.length -1 ||
		this._window_select._index < 0){ this._window_select.select(0);}
	if( $gameTemp._drill_SSpM_visibleList.length == 0 ){ return };	//如果选项全部为空，强制选择第一个
...
// * 信息面板M（场景基类） - 开始运行
//==============================
Scene_Drill_SSpM.prototype.start = function() {
    Scene_MenuBase.prototype.start.call(this);
};
//==============================
// * 信息面板M（场景基类） - 结束运行
//==============================
Scene_Drill_SSpM.prototype.stop = function() {
    Scene_MenuBase.prototype.stop.call(this);
};
//==============================
// * 信息面板M（场景基类） - 判断是否激活/启动
//==============================
Scene_Drill_SSpM.prototype.isActive = function() {
	return Scene_MenuBase.prototype.isActive.call(this);
};
//==============================
// * 信息面板M（场景基类） - 析构函数
//==============================
Scene_Drill_SSpM.prototype.terminate = function() {
...
// * 信息面板M（场景基类） - 判断加载完成
//==============================
Scene_Drill_SSpM.prototype.isReady = function() {
	return Scene_MenuBase.prototype.isReady.call(this);
};
//==============================
// * 信息面板M（场景基类） - 忙碌状态
//==============================
Scene_Drill_SSpM.prototype.isBusy = function() {
	return Scene_MenuBase.prototype.isBusy.call(this);
};

//==============================
// * 信息面板M（菜单界面基类） - 创建 - 菜单背景
//==============================
Scene_Drill_SSpM.prototype.createBackground = function() {
	Scene_MenuBase.prototype.createBackground.call(this);
};
//==============================
// * 信息面板M（菜单界面基类） - 创建 - 帮助窗口
//==============================
Scene_Drill_SSpM.prototype.createHelpWindow = function() {
...
// * 选项窗口 - 定义
//==============================
function Drill_SSpM_SelectWindow() {
	this.initialize.apply(this, arguments);
}
Drill_SSpM_SelectWindow.prototype = Object.create(Window_Selectable.prototype);
Drill_SSpM_SelectWindow.prototype.constructor = Drill_SSpM_SelectWindow;
Drill_SSpM_SelectWindow.lastTopRow = 0;
Drill_SSpM_SelectWindow.lastIndex  = 0;
//==============================
// * 选项窗口 - 初始化
//==============================
Drill_SSpM_SelectWindow.prototype.initialize = function(x, y, width, height) {
...
// * 选项窗口 - 窗口数据
//==============================
Drill_SSpM_SelectWindow.prototype.maxCols = function() {
	return DrillUp.g_SSpM_command_window['col'] || 1;
};
Drill_SSpM_SelectWindow.prototype.maxItems = function() {
	return this._list ? this._list.length : 0;
};
Drill_SSpM_SelectWindow.prototype.itemHeight = function() {
	return DrillUp.g_SSpM_command_window['itemHeight'] || this.lineHeight();
};

//==============================
// * 选项窗口 - 帧刷新
//==============================
Drill_SSpM_SelectWindow.prototype.update = function() {
...
// * 选项窗口 - 重绘内容
//==============================
Drill_SSpM_SelectWindow.prototype.refresh = function() {
	$gameTemp._drill_SSpM_visibleList = [];
	...
	for(var i=1; i<= DrillUp.g_SSpM_context_list_length ;i++){
		...
		if( $gameTemp.drill_SSpM_isEnabled( i ) == true ){
			$gameTemp._drill_SSpM_visibleList.push( temp_c );
	...
	// > 待绘制的字符串
	this._list = [];
	for( var j=0; j< $gameTemp._drill_SSpM_visibleList.length ;j++ ){
		var temp_c = $gameTemp._drill_SSpM_visibleList[j];
		var context_realIndex = temp_c['index'];
		
		// > 选项锁定
		if( $gameTemp.drill_SSpM_isLocked( context_realIndex ) == true ){
			this._list.push( DrillUp.g_SSpM_locked_name );
			continue;
		}
		
		// > 长文本选项
		if( DrillUp.g_SSpM_command_window['nameExEnabled'] == true ){
...
// * 选项窗口 - 设置选项
//==============================
Drill_SSpM_SelectWindow.prototype.drill_initSelect = function() {
	if( Drill_SSpM_SelectWindow.lastIndex >= this._list.length ){
		Drill_SSpM_SelectWindow.lastIndex = this._list.length-1;
	}
	this.setTopRow(Drill_SSpM_SelectWindow.lastTopRow);
	this.select(Drill_SSpM_SelectWindow.lastIndex);
}
//==============================
// * 选项窗口 - 绘制选项
//==============================
Drill_SSpM_SelectWindow.prototype.drawItem = function(index) {
	...
	// > 绘制内容
	var op = {
		"align":DrillUp.g_SSpM_command_window['align'],
		"autoLineheight":true,
		"x": rect.x,
		"y": rect.y,
		"width": rect.width,
...
// * 选项窗口 - 退出事件
//==============================
Drill_SSpM_SelectWindow.prototype.processCancel = function() {
	Window_Selectable.prototype.processCancel.call(this);
	Drill_SSpM_SelectWindow.lastTopRow = this.topRow();
	Drill_SSpM_SelectWindow.lastIndex = this.index();
};
//==============================
// * 选项窗口 - 兼容 - mog菜单指针插件
//==============================
if( Imported.MOG_MenuCursor == true ){
	var _drill_SSpM_mog_set_mcursor_data = Drill_SSpM_SelectWindow.prototype.need_set_mcursor_data;
	Drill_SSpM_SelectWindow.prototype.need_set_mcursor_data = function() {
		if( DrillUp.g_SSpM_command_window['cursor']['mog_enabled'] == false ){
			return false;
		}
		return _drill_SSpM_mog_set_mcursor_data.call(this);
	}
}
//==============================
// * 选项窗口 - 兼容 - mog菜单边框插件
...
if( Imported.MOG_CursorBorder == true ){
	var _drill_SSpM_mog_createSprSelMenu = Drill_SSpM_SelectWindow.prototype.createSprSelMenu;
	Drill_SSpM_SelectWindow.prototype.createSprSelMenu = function() {
		if( DrillUp.g_SSpM_command_window['cursor']['mog_borderEnabled'] == false ){
			return ;
		}
		_drill_SSpM_mog_createSprSelMenu.call(this);
	}
}
//==============================
...
if( Imported.Drill_MenuCursor == true ){
	Drill_SSpM_SelectWindow.prototype.drill_MCu_cursorEnabled = function() {
		return DrillUp.g_SSpM_command_window['cursor']['MCu_enabled'];
	}
	Drill_SSpM_SelectWindow.prototype.drill_MCu_cursorStyleId = function() {
		if( DrillUp.g_SSpM_command_window['cursor']['MCu_lock'] == true ){
			return DrillUp.g_SSpM_command_window['cursor']['MCu_style'];
		}else{
...
if( Imported.Drill_MenuCursorBorder == true ){
	Drill_SSpM_SelectWindow.prototype.drill_MCB_glimmerRectVisible = function() {
		return DrillUp.g_SSpM_command_window['cursor']['MCB_rectEnabled'];
	}
	Drill_SSpM_SelectWindow.prototype.drill_MCB_borderEnabled = function() {
		return DrillUp.g_SSpM_command_window['cursor']['MCB_enabled'];
	}
	Drill_SSpM_SelectWindow.prototype.drill_MCB_borderStyleId = function() {
		if( DrillUp.g_SSpM_command_window['cursor']['MCB_lock'] == true ){
			return DrillUp.g_SSpM_command_window['cursor']['MCB_style'];
		}else{
...
if( Imported.Drill_MenuScrollBar == true ){
	Drill_SSpM_SelectWindow.prototype.drill_MSB_scrollBarEnabled = function() {
		return DrillUp.g_SSpM_command_window['cursor']['MSB_enabled'];
	}
	Drill_SSpM_SelectWindow.prototype.drill_MSB_scrollBarStyleId = function() {
		if( DrillUp.g_SSpM_command_window['cursor']['MSB_lock'] == true ){
			return DrillUp.g_SSpM_command_window['cursor']['MSB_style'];
		}else{
...
// * 显示窗口 - 定义
//==============================
function Drill_SSpM_DescWindow() {
    this.initialize.apply(this, arguments);
}
Drill_SSpM_DescWindow.prototype = Object.create(Window_Base.prototype);
Drill_SSpM_DescWindow.prototype.constructor = Drill_SSpM_DescWindow;
//==============================
// * 显示窗口 - 初始化
//==============================
Drill_SSpM_DescWindow.prototype.initialize = function(x, y, width, height, i) {
...
// * 显示窗口 - 帧刷新
//==============================
Drill_SSpM_DescWindow.prototype.update = function() {
...
// * 显示窗口 - 重绘内容
//==============================
Drill_SSpM_DescWindow.prototype.drill_refreshDesc = function( cur_index ) {
	var temp_list = $gameTemp._drill_SSpM_visibleList;		//可见项列表
	...
	if( $gameTemp.drill_SSpM_isLocked( context_realIndex ) == true && 
	   (DrillUp.g_SSpM_locked_type == "锁定描述图和描述内容" || 
		...
		context_list = DrillUp.g_SSpM_locked_context;		//锁定内容
	}else{
...
//=============================================================================
		...
		Imported.Drill_SceneSelfplateM = false;
		var pluginTip = DrillUp.drill_SSpM_getPluginTip_NoBasePlugin();
		alert( pluginTip );
}
