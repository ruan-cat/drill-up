...
Game_Character.prototype.drill_ECE_updateSustainingRotate = function() {
	...
	// > 锚点(0.5,0.5)锁定
	var fix_point = $gameTemp.drill_ECE_Math2D_getFixPointInAnchor( 0.5,1.0, 0.5,0.5, ef.real_width,ef.real_height, ef.rotation, ef.scale_x+1, ef.scale_y+1 );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
...
Game_Character.prototype.drill_ECE_updateSustainingShakeRotate = function() {
	...
	// > 锚点(0.5,1.0)锁定
	var fix_point = $gameTemp.drill_ECE_Math2D_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,1.0, ef.real_width,ef.real_height, ef.rotation, ef.scale_x+1, ef.scale_y+1 );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
...
Game_Character.prototype.drill_ECE_updateSustainingPendulumRotate = function() {
	...
	// > 锚点(0.5,1.0)锁定
	var fix_point = $gameTemp.drill_ECE_Math2D_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,0.0, ef.real_width,ef.real_height, ef.rotation, ef.scale_x+1, ef.scale_y+1 );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
...
Game_Character.prototype.drill_ECE_playSustainingJumping = function( time,period,jump_height ) {
	...
	ef.fA_abc = $gameTemp.drill_ECE_Math2D_getParabolicThree( 0,0, ef.fA_dTime*0.5,-0.1, ef.fA_dTime,0 );
	
	ef.fB_time = 0;
	ef.fB_dTime = period*0.6;
	ef.fB_abc = $gameTemp.drill_ECE_Math2D_getParabolicThree( 0,0, ef.fB_dTime*0.5,jump_height, ef.fB_dTime,0 );
	
	ef.fC_time = 0;
	ef.fC_dTime = period*0.15;
	ef.fC_abc = $gameTemp.drill_ECE_Math2D_getParabolicThree( 0,0, ef.fC_dTime*0.5,-0.1, ef.fC_dTime,0 );
...
Game_Character.prototype.drill_ECE_updateSustainingZooming = function() {
	...
	// > 锚点(0.5,0.5)锁定
	var fix_point = $gameTemp.drill_ECE_Math2D_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,0.5, ef.real_width,ef.real_height, ef.rotation, ef.scale_x+1, ef.scale_y+1 );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
