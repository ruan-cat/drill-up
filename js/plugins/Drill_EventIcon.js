...
//
//		★存在的问题：
//			1.问题：有一个比较不明用途的函数：ImageManager.requestCharacter。
//			  解决：【已解决】，2022-1-6 此函数与加载资源功能一样，只是加载失败不会报错。
//		
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_EI_PluginTip_curName = "Drill_EventIcon.js 行走图-图标行走图";
	DrillUp.g_EI_PluginTip_baseList = [];
