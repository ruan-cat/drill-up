//=============================================================================
// Drill_EventDynamicMaskA.js
//=============================================================================

/*:
 * @plugindesc [v1.1]        行走图 - 行走图动态遮罩板A
 * @author Drill_up
 * 
 * @Drill_LE_param "透视镜样式-%d"
 * @Drill_LE_parentKey "---透视镜样式组%d至%d---"
 * @Drill_LE_var "DrillUp.g_EDMA_childData_length"
 * 
 * 
 * @help 
 * =============================================================================
 * +++ Drill_EventDynamicMaskA +++
 * 作者：Drill_up
 ...
 * 你需要给指定图片开启动态遮罩板功能：
 * 
 * 事件注释：=>行走图动态遮罩板A : 启用该插件的动态遮罩板
 * 事件注释：=>行走图动态遮罩板A : 停用动态遮罩板
 * 
 * 插件指令：>行走图动态遮罩板A : 玩家 : 启用该插件的动态遮罩板
 * 插件指令：>行走图动态遮罩板A : 本事件 : 启用该插件的动态遮罩板
 * 插件指令：>行走图动态遮罩板A : 事件[10] : 启用该插件的动态遮罩板
 * 插件指令：>行走图动态遮罩板A : 事件变量[21] : 启用该插件的动态遮罩板
 * 插件指令：>行走图动态遮罩板A : 批量事件[10,11] : 启用该插件的动态遮罩板
 * 插件指令：>行走图动态遮罩板A : 批量事件变量[21,22] : 启用该插件的动态遮罩板
 * 
 * 插件指令：>行走图动态遮罩板A : 图片[1] : 启用该插件的动态遮罩板
 * 插件指令：>行走图动态遮罩板A : 图片[1] : 停用动态遮罩板
 * 
 ...
 * 你可以通过下列指令添加简单透视镜：
 * 
 * 事件注释：=>行走图动态遮罩板A : 简单透视镜 : 样式[1]
 * 事件注释：=>行走图动态遮罩板A : 简单透视镜 : 清除
 * 
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 玩家 : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 本事件 : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 事件[10] : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 事件变量[21] : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 批量事件[10,11] : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 批量事件变量[21,22] : 样式[1]
 * 
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 玩家 : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 玩家 : 清除
 * 
 ...
 * 
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 鼠标 : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 图片[10] : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 图片变量[21] : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 批量图片[10,11] : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 批量图片变量[21,22] : 样式[1]
 * 
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 鼠标 : 样式[1]
 * 插件指令：>行走图动态遮罩板A : 简单透视镜 : 鼠标 : 清除
 * 
 ...
 * 你可以通过插件指令创建设置高级透视镜：
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 创建 : 样式[3]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 清除
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 设置生命 : 持续时间[180]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 暂停生命流逝
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 继续生命流逝
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 玩家
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 本事件
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 事件[10]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 事件变量[10]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 鼠标
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 图片[10]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 绑定到 : 图片变量[10]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 位置归零
 * 
 ...
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜变量[21] : 创建 : 样式[3]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜变量[21] : 清除
 * 插件指令：>行走图动态遮罩板A : 获取未创建的高级透视镜编号[100-200] : 变量[21]
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜变量[2] : 设置生命 : 持续时间[180]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜变量[2] : 暂停生命流逝
 * 插件指令：>行走图动态遮罩板A : 高级透视镜变量[2] : 继续生命流逝
 * 
 ...
 * 你可以通过插件指令控制高级透视镜移动：
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 瞬间移动 : 位置[100,200]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速移动 : 位置[100,200] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 增减速移动 : 位置[100,200] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 弹性移动 : 位置[100,200] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 抛物线移动 : 位置[100,200] : 时间[20]
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速移动 : 位置[100,200] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速移动 : 位置变量[25,26] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速移动 : 相对位置[-100,0] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速移动 : 相对位置变量[25,26] : 时间[20]
 * 
 ...
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 瞬间变化 : 缩放X[1.2]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速变化 : 缩放X[1.2] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 增减速变化 : 缩放X[1.2] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 弹性变化 : 缩放X[1.2] : 时间[20]
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 瞬间变化 : 缩放Y[1.2]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速变化 : 缩放Y[1.2] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 增减速变化 : 缩放Y[1.2] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 弹性变化 : 缩放Y[1.2] : 时间[20]
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 瞬间变化 : 透明度[255]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速变化 : 透明度[255] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 增减速变化 : 透明度[255] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 弹性变化 : 透明度[255] : 时间[20]
 * 
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 瞬间变化 : 旋转角度[90]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 匀速变化 : 旋转角度[90] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 增减速变化 : 旋转角度[90] : 时间[20]
 * 插件指令：>行走图动态遮罩板A : 高级透视镜[2] : 弹性变化 : 旋转角度[90] : 时间[20]
 * 
...
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
//		插件简称		EDMA（Core_Of_Dynamic_Mask）
//		临时全局变量	DrillUp.g_EDMA_xxx
//		临时局部变量	this._drill_EDMA_xxx
//		存储数据变量	无
//		全局存储变量	无
//		覆盖重写方法	无
//
...
//		★时间复杂度		o(n^2)*o(贴图处理)*o(遮罩渲染) 每帧
//		★性能测试因素	遮罩管理层
//		★性能测试消耗	28.96ms（Scene_Map.prototype.update,与地图遮罩一样，两个加起来为CODM的消耗）40.29ms（drill_EDMA_updateCharacterSprite）
...
　　var DrillUp = DrillUp || {}; 
    DrillUp.parameters = PluginManager.parameters('Drill_EventDynamicMaskA');
	...
	/*-----------------透视镜样式------------------*/
	DrillUp.g_EDMA_childData_length = 200;
	DrillUp.g_EDMA_childData = [];	
	for (var i = 0; i < DrillUp.g_EDMA_childData_length; i++) {
		if( DrillUp.parameters["透视镜样式-" + String(i+1) ] != "" &&
			...
			DrillUp.g_EDMA_childData[i] = DrillUp.drill_EDMA_childSpriteInit( data );
		}else{
			DrillUp.g_EDMA_childData[i] = null;
		}
	}
...
// * 插件指令
//=============================================================================
var _drill_EDMA_pluginCommand = Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	_drill_EDMA_pluginCommand.call(this, command, args);
	if( command === ">行走图动态遮罩板A" ){
			...
			if( temp2 == "启用该插件的动态遮罩板" || temp2 == "停用动态遮罩板" ){
				...
				if( char_list == null && obj_str.indexOf("批量事件[") != -1 ){
					...
					for( var k=0; k < temp_arr.length; k++ ){
						...
						if( $gameMap.drill_EDMA_isEventExist( e_id ) == false ){ continue; }
						char_list.push( e_id );
					}
				}
				...
				if( char_list == null && obj_str.indexOf("事件[") != -1 ){
					...
					if( $gameMap.drill_EDMA_isEventExist( e_id ) == false ){ return; }
					char_list = [ e_id ];
				}
				...
				if( char_list != null && char_list.length > 0 ){
					for( var j=0; j < char_list.length; j++ ){
						...
						if( temp2 == "启用该插件的动态遮罩板" ){
							if( char_id > 0 ){
								$gameMap.event( char_id )._drill_EDMA_maskBind = "行走图动态遮罩板A";
							}
							if( char_id == -2 ){	//『玩家id』
								$gamePlayer._drill_EDMA_maskBind = "行走图动态遮罩板A";
							}
						}
						if( temp2 == "停用动态遮罩板" ){
							if( char_id > 0 ){
								$gameMap.event( char_id )._drill_EDMA_maskBind = null;
							}
							if( char_id == -2 ){	//『玩家id』
								$gamePlayer._drill_EDMA_maskBind = null;
							}
						}
					}
				}
		...
		if( args.length >= 4 ){
			...
			if( pics == null && obj_str.indexOf("批量图片[") != -1 ){
				...
				for( var k=0; k < temp_arr.length; k++ ){
					...
					if( $gameScreen.drill_EDMA_isPictureExist( pic_id ) == false ){ continue; }
					pics.push( pic_id );
				}
			}
			...
			if( pics == null && obj_str.indexOf("图片变量[") != -1 ){
				...
				if( $gameScreen.drill_EDMA_isPictureExist( pic_id ) == false ){ return; }
				pics = [ pic_id ];
			}
		...
		if( args.length == 6 ){
			...
			if( temp1.indexOf("高级透视镜[") != -1 && temp2 == "创建" ){
				...
				$gameMap.drill_EDMA_addSeniorPerspect( temp1, temp3 );
				return;
		...
		if( args.length == 4 ){
			...
			if( temp1.indexOf("高级透视镜[") != -1 && temp2 == "清除" ){
				...
				temp1 = temp1.replace("]","");
				temp1 = Number(temp1);
				$gameMap.drill_EDMA_removeSeniorPerspect( temp1 );
				return;
				...
				if( temp_arr.length >= 2 ){
					var id = $gameSystem._drill_EDMA_container.drill_CODM_getEmptyId( Number(temp_arr[0]), Number(temp_arr[1]) );
		...
		if( marker != null && args.length == 4 ){
			...
			if( type == "位置归零" ){
				...
				$gameSystem.drill_EDMA_moveTo( marker.drill_id(), m_data );
			}
		}
		/*-----------------高级透视镜 - 移动------------------*/
		...
		if( marker != null && (args.length == 6 || args.length == 8) ){
			...
			if( type == "瞬间变化" || type == "匀速变化" || type == "增减速变化" || type == "弹性变化" ){
				...
				if( temp1.indexOf("缩放X[") != -1 ){
					...
					$gameSystem.drill_EDMA_scaleXTo( marker.drill_id(), o_data );
				}
				if( temp1.indexOf("缩放Y[") != -1 ){
					...
					$gameSystem.drill_EDMA_scaleYTo( marker.drill_id(), o_data );
				}
			}
		}
		/*-----------------高级透视镜 - 透明度变化------------------*/
		if( marker != null && (args.length == 6 || args.length == 8) ){
			...
			if( type == "瞬间变化" || type == "匀速变化" || type == "增减速变化" || type == "弹性变化" ){
				...
				if( temp1.indexOf("透明度[") != -1 ){
					...
					$gameSystem.drill_EDMA_opacityTo( marker.drill_id(), o_data );
				}
			}
		}
		/*-----------------高级透视镜 - 旋转变化------------------*/
		if( marker != null && (args.length == 6 || args.length == 8) ){
			...
			if( type == "瞬间变化" || type == "匀速变化" || type == "增减速变化" || type == "弹性变化" ){
				...
				if( temp1.indexOf("旋转角度[") != -1 ){
					...
					$gameSystem.drill_EDMA_rotateTo( marker.drill_id(), o_data );
				}
			}
		}
	}
...
// ** 插件指令 - 事件检查
//==============================
Game_Map.prototype.drill_EDMA_isEventExist = function( e_id ){
...
// ** 插件指令 - 图片检查
//==============================
Game_Screen.prototype.drill_EDMA_isPictureExist = function( pic_id ){
...
// * 事件 - 注释初始化
//==============================
var _drill_EDMA_setupPage = Game_Event.prototype.setupPage;
Game_Event.prototype.setupPage = function() {
	_drill_EDMA_setupPage.call(this);
    this.drill_EDMA_setup();
};
Game_Event.prototype.drill_EDMA_setup = function() {		
	...
	if( !this._erased && this.page() ){ this.list().forEach(function( l ){
		if( l.code === 108 ){
			...
			if( command == "=>行走图动态遮罩板A" ){
				if(args.length == 2){		//=>行走图动态遮罩板A : 启用该插件的动态遮罩板
					var type = String(args[1]);
					if( type == "启用该插件的动态遮罩板" ){
						this._drill_EDMA_maskBind = "行走图动态遮罩板A";
					}
					if( type == "停用动态遮罩板" ){
						this._drill_EDMA_maskBind = null;
					}
				}
				if(args.length == 4){		//=>行走图动态遮罩板A : 简单透视镜 : 样式[1]
					var type = String(args[1]);
...
//##############################
DrillUp.g_EDMA_saveEnabled = true;
//##############################
// * 存储数据 - 初始化
//          
//			说明：	> 下方为固定写法，不要动。
//##############################
var _drill_EDMA_sys_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    _drill_EDMA_sys_initialize.call(this);
	this.drill_EDMA_initSysData();
};
//##############################
// * 存储数据 - 载入存档
//          
//			说明：	> 下方为固定写法，不要动。
//##############################
var _drill_EDMA_sys_extractSaveContents = DataManager.extractSaveContents;
DataManager.extractSaveContents = function( contents ){
	_drill_EDMA_sys_extractSaveContents.call( this, contents );
	
	// > 参数存储 启用时（检查数据）
	if( DrillUp.g_EDMA_saveEnabled == true ){	
		$gameSystem.drill_EDMA_checkSysData();
		
	// > 参数存储 关闭时（直接覆盖）
	}else{
		$gameSystem.drill_EDMA_initSysData();
	}
};
//##############################
// * 存储数据 - 初始化数据【标准函数】
...
//##############################
Game_System.prototype.drill_EDMA_initSysData = function() {
	this.drill_EDMA_initSysData_Private();
};
//##############################
// * 存储数据 - 载入存档时检查数据【标准函数】
//			
...
//##############################
Game_System.prototype.drill_EDMA_checkSysData = function() {
	this.drill_EDMA_checkSysData_Private();
};
//=============================================================================
// ** 存储数据（接口实现）
//=============================================================================
...
// * 存储数据 - 初始化数据（私有）
//==============================
Game_System.prototype.drill_EDMA_initSysData_Private = function() {
	
	this._drill_EDMA_container = new Drill_CODM_PerspectiveMarkerContainer();	//（创建容器）
};
//==============================
// * 存储数据 - 载入存档时检查数据（私有）
//==============================
Game_System.prototype.drill_EDMA_checkSysData_Private = function() {
	
	// > 旧存档数据自动补充
	if( this._drill_EDMA_container == undefined ){
		this.drill_EDMA_initSysData();
	}
...
// * 位置 - 移动设置
//==============================
Game_System.prototype.drill_EDMA_moveTo = function( marker_id, m_data ){
	var marker = this._drill_EDMA_container.drill_CODM_getSeniorMarkerById( marker_id );
	//if( marker == undefined ){	//（如果还没来得及创建，则放入变化容器中）
	//	this._drill_EDMA_command_moveBuffer[ marker_id ] = m_data;
	//	return;
	//}
...
// * 位置 - 缩放X设置
//==============================
Game_System.prototype.drill_EDMA_scaleXTo = function( marker_id, o_data ){
	var marker = this._drill_EDMA_container.drill_CODM_getSeniorMarkerById( marker_id );
...
// * 位置 - 缩放Y设置
//==============================
Game_System.prototype.drill_EDMA_scaleYTo = function( marker_id, o_data ){
	var marker = this._drill_EDMA_container.drill_CODM_getSeniorMarkerById( marker_id );
...
// * 位置 - 透明度设置
//==============================
Game_System.prototype.drill_EDMA_opacityTo = function( marker_id, o_data ){
	var marker = this._drill_EDMA_container.drill_CODM_getSeniorMarkerById( marker_id );
...
// * 位置 - 旋转设置
//==============================
Game_System.prototype.drill_EDMA_rotateTo = function( marker_id, o_data ){
	var marker = this._drill_EDMA_container.drill_CODM_getSeniorMarkerById( marker_id );
...
// * 物体容器 - 地图初始化
//==============================
var _drill_EDMA_map_setupEvents = Game_Map.prototype.setupEvents;
Game_Map.prototype.setupEvents = function(){
	$gameSystem._drill_EDMA_container.drill_CODM_clearSimple();	//（清理简单透视镜）
	_drill_EDMA_map_setupEvents.call( this );
}
//==============================
// * 物体容器 - 地图帧刷新
//==============================
var _drill_EDMA_map_update = Game_Map.prototype.update;
Game_Map.prototype.update = function( sceneActive ){
	_drill_EDMA_map_update.call( this,sceneActive );
	if( sceneActive ){
		$gameSystem._drill_EDMA_container.update();		//（容器帧刷新）
	}
};
//==============================
// * 物体容器 - 添加简单透视镜（事件/玩家）
...
Game_Map.prototype.drill_EDMA_addSimplePerspect_characterId = function( character_id, style_id ){	
	...
	$gameSystem._drill_EDMA_container.drill_CODM_addOne( marker );	//（添加到容器）
}
//==============================
// * 物体容器 - 去除简单透视镜（事件/玩家）
//==============================
Game_Map.prototype.drill_EDMA_removeSimplePerspect_characterId = function( character_id ){
	var marker = $gameSystem._drill_EDMA_container.drill_CODM_getSimpleMarkerByCharacterId( character_id );
...
// * 物体容器 - 去除简单透视镜（鼠标）
//==============================
Game_Map.prototype.drill_EDMA_removeSimplePerspect_mouse = function(){
	var marker = $gameSystem._drill_EDMA_container.drill_CODM_getSimpleMarkerByMouse();
	if( marker == undefined ){ return; }
	marker.drill_destroy();											//（清除透视镜）
}
//==============================
...
// * 物体容器 - 去除简单透视镜（图片）
//==============================
Game_Map.prototype.drill_EDMA_removeSimplePerspect_picId = function( pic_id ){
	var marker = $gameSystem._drill_EDMA_container.drill_CODM_getSimpleMarkerByPictureId( pic_id );
	if( marker == undefined ){ return; }
	marker.drill_destroy();											//（清除透视镜）
}
//==============================
...
//==============================
Game_Map.prototype.drill_EDMA_removeSeniorPerspect = function( marker_id ){
	var marker = $gameSystem._drill_EDMA_container.drill_CODM_getSeniorMarkerById( marker_id );
	if( marker == undefined ){ return; }
	marker.drill_destroy();											//（清除透视镜）
}
...
// * 贴图容器 - 初始化
//==============================
var _drill_EDMA_temp_initialize = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function() {	
	_drill_EDMA_temp_initialize.call(this);
	this._drill_EDMA_sprites = [];				//缓冲池 - 鼠标贴图
	this._drill_EDMA_needSort = true;			//排序标记
	this._drill_EDMA_opened = false;			//容器开关
};
//==============================
// * 贴图容器 - 切换地图时
//==============================
var _drill_EDMA_gmap_setup = Game_Map.prototype.setup;
Game_Map.prototype.setup = function( mapId ){
	$gameTemp._drill_EDMA_sprites = [];	
	$gameTemp._drill_EDMA_opened = false;		//容器开关
	_drill_EDMA_gmap_setup.call( this,mapId );
}
//==============================
// * 贴图容器 - 切换贴图时（菜单界面刷新）
//==============================
var _drill_EDMA_smap_createCharacters = Spriteset_Map.prototype.createCharacters;
Spriteset_Map.prototype.createCharacters = function() {
	$gameTemp._drill_EDMA_sprites = [];	
	_drill_EDMA_smap_createCharacters.call(this);
}
//==============================
// * 贴图容器 - 获取透视镜贴图（根据透视镜物体）
//==============================
Game_Temp.prototype.drill_EDMA_getPerspectiveSpriteByMarker = function( marker ){
	for(var i=0; i < $gameTemp._drill_EDMA_sprites.length; i++ ){
		var temp_sprite = $gameTemp._drill_EDMA_sprites[i];
...
// * 贴图容器 - 帧刷新 创建/删除 贴图
//==============================
Scene_Map.prototype.drill_EDMA_updateCheck = function() {
	
	// > 删除贴图
	for(var i = $gameTemp._drill_EDMA_sprites.length-1; i >= 0; i--){
		var temp_sprite = $gameTemp._drill_EDMA_sprites[i];
		if( temp_sprite.drill_isDestroyed() ){
			this.drill_EDMA_removeMaskChild( temp_sprite );
			$gameTemp._drill_EDMA_sprites.splice( i, 1 );
		}
	}
	
	// > 创建贴图
	var tank = $gameSystem._drill_EDMA_container.drill_CODM_getTank();
	if( tank.length > $gameTemp._drill_EDMA_sprites.length ){
		
		for(var i=0; i < tank.length; i++ ){		//（从物体列表中，依次找贴图对应的物体）
			var temp_marker = tank[i];
			var temp_sprite = $gameTemp.drill_EDMA_getPerspectiveSpriteByMarker( temp_marker );
			if( temp_sprite != undefined ){ continue; }
			
			var new_sprite = new Drill_CODM_PerspectiveSprite( temp_marker );
			this.drill_EDMA_addMaskChild( new_sprite );
			$gameTemp._drill_EDMA_sprites.push( new_sprite );
			if( tank.length == $gameTemp._drill_EDMA_sprites.length ){
				break;
			}
		}
		$gameTemp._drill_EDMA_needSort = true;
	}
}
...
// * 动态遮罩板 - 遮罩容器
//==============================
Scene_Map.prototype.drill_EDMA_createMaskLayer = function() {
	
	// > 动态遮罩容器
	var temp_stage = new Drill_CODM_MaskStage( Graphics.boxWidth, Graphics.boxHeight );
	this._drill_EDMA_maskStage = temp_stage;
	
};
//==============================
// * 动态遮罩板 - 获取遮罩容器（接口）
//==============================
Scene_Map.prototype.drill_EDMA_getMaskStage = function(){
	return this._drill_EDMA_maskStage;
}
//==============================
// * 动态遮罩板 - 获取贴图（接口）
//
//			说明：	如果你要从 _drill_EDMA_maskStage 那里获取内容，最好通过该接口函数调用，而不是直接调用。
//==============================
Scene_Map.prototype.drill_EDMA_getMaskSprite = function(){
	$gameTemp._drill_EDMA_opened = true;
	return this._drill_EDMA_maskStage.drill_CODM_getNewSprite();
}
//==============================
// * 动态遮罩板 - 添加 透视镜贴图（接口）
//==============================
Scene_Map.prototype.drill_EDMA_addMaskChild = function( new_sprite ){
	this._drill_EDMA_maskStage.drill_CODM_addMaskChild( new_sprite );
}
//==============================
// * 动态遮罩板 - 删除 透视镜贴图（接口）
//==============================
Scene_Map.prototype.drill_EDMA_removeMaskChild = function( new_sprite ){
	this._drill_EDMA_maskStage.drill_CODM_removeMaskChild( new_sprite );
}
//==============================
// * 动态遮罩板 - 判断容器开关（接口）
//==============================
Scene_Map.prototype.drill_EDMA_isMaskOpened = function(){	
	if( $gameTemp._drill_EDMA_opened == true ){
		return true;
	}
	return false;
};
...
//==============================
Scene_Map.prototype.drill_EDMA_setMaskOpened = function( b ){	
	$gameTemp._drill_EDMA_opened = b;
}
...
// * 地图界面 - 创建
//==============================
var _drill_EDMA_Scene_initialize = Scene_Map.prototype.initialize;
Scene_Map.prototype.initialize = function() {
	_drill_EDMA_Scene_initialize.call(this);
	this.drill_EDMA_createMaskLayer();		//（容器必须在所有 场景装饰插件 之前创建）
};
//==============================
// * 地图界面 - 帧刷新
//==============================
var _drill_EDMA_scene_update = Scene_Map.prototype.update;
Scene_Map.prototype.update = function() {	
	_drill_EDMA_scene_update.call(this);
	
	// > 开启后才使用
	if( this.drill_EDMA_isMaskOpened() == false ){ return; }
	
	// > 测试 - update激活监听
	//if( DrillUp.g_EDMA_debugUpdate == true ){
	//	DrillUp.g_EDMA_debugUpdate = false;
	//	alert("行走图动态遮罩板A 开始帧刷新。");
	//}
	
	// > 刷新统计
	this.drill_EDMA_updateCheck();
	
	// > 容器帧刷新
	this._drill_EDMA_maskStage.update();
	
	// > 透视镜 排序（延迟）
	if( $gameTemp._drill_EDMA_needSort == true ){
		$gameTemp._drill_EDMA_needSort = false;
		this._drill_EDMA_maskStage.drill_CODM_sortByZIndex();
	}
};
DrillUp.g_EDMA_debugUpdate = true;
...
// * 事件 - 初始化
//==============================
var _drill_EDMA_ch_initialize = Game_CharacterBase.prototype.initialize;
Game_CharacterBase.prototype.initialize = function() {
	_drill_EDMA_ch_initialize.call( this );
	this._drill_EDMA_maskBind = null;
}
//==============================
// * 图片贴图 - 初始化
//==============================
var _drill_EDMA_sc_initialize = Sprite_Character.prototype.initialize;
Sprite_Character.prototype.initialize = function( character ){
	_drill_EDMA_sc_initialize.call( this, character );
	
	this._drill_EDMA_curMaskBind = null;
	this._drill_EDMA_maskSprite = null;
}
//==============================
// * 图片贴图 - 帧刷新
//
...
//==============================
Scene_Map.prototype.drill_EDMA_updateCharacterSprite = function(){	
	...
	for(var i=0; i < sprite_list.length; i++ ){
		...
		// > 根据 图片贴图与图片数据 锁
		if( ch._drill_EDMA_maskBind == temp_sprite._drill_EDMA_curMaskBind ){ continue; }
		temp_sprite._drill_EDMA_curMaskBind = ch._drill_EDMA_maskBind;
		
		// > 数据变化时，只执行一次遮罩切换
		if( ch._drill_EDMA_maskBind == "行走图动态遮罩板A" ){
			temp_sprite._drill_EDMA_maskSprite = this.drill_EDMA_getMaskSprite();
			temp_sprite.mask = temp_sprite._drill_EDMA_maskSprite;		//『遮罩赋值』
		}
		if( ch._drill_EDMA_maskBind == null ){
...
// * 地图界面 - 帧刷新绑定
//==============================
var _drill_EDMA_mapScene_update2 = Scene_Map.prototype.update;
Scene_Map.prototype.update = function() {	
	_drill_EDMA_mapScene_update2.call(this);
	this.drill_EDMA_updateCharacterSprite();
}
