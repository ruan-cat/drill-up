...
//##############################
Drill_ASu_Controller.prototype.drill_controller_update = function(){
	...
	this.drill_controller_updateGIF();					//帧刷新 - C播放GIF
														//帧刷新 - E自动调整效果（无）
	this.drill_ASu_updateState();						//帧刷新 - 2A阶段
...
//##############################
Drill_ASu_Controller.prototype.drill_controller_resetData = function( data ){
...
//			说明：	> 可放在帧刷新函数中实时调用。
//##############################
Drill_ASu_Controller.prototype.drill_controller_setVisible = function( visible ){
...
//			说明：	> 可放在帧刷新函数中实时调用。
//##############################
Drill_ASu_Controller.prototype.drill_controller_setPause = function( pause ){
	var data = this._drill_data;
	data['pause'] = pause;
};
//##############################
...
//			返回：	> 布尔
//##############################
Drill_ASu_Controller.prototype.drill_controller_destroy = function(){
...
//			返回：	> 布尔
//##############################
Drill_ASu_Controller.prototype.drill_controller_isDead = function(){
...
//					  该对象包含 类所需的所有默认值。
//##############################
Drill_ASu_Controller.prototype.drill_controller_initData = function(){
	var data = this._drill_data;
...
// * 初始化 - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_controller_initChild = function(){
	...
	this.drill_ASu_initState();					//初始化子功能 - 2A阶段
}
//==============================
// * 控制器 - 重设数据（私有）
//
//			说明：	data对象中的参数【可以缺项】。
//==============================
Drill_ASu_Controller.prototype.drill_controller_resetData_Private = function( data ){
...
// * A主体 - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_controller_initAttr = function() {
	var data = this._drill_data;
...
// * A主体 - 帧刷新
//==============================
Drill_ASu_Controller.prototype.drill_controller_updateAttr = function() {
	var data = this._drill_data;
...
// * A主体 - 帧刷新 - 校验值
//==============================
Drill_ASu_Controller.prototype.drill_controller_updateCheckNaN = function(){
...
// * B变化控制 - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_controller_initChange = function() {
	var data = this._drill_data;
...
// * B变化控制 - 帧刷新 位置
//==============================
Drill_ASu_Controller.prototype.drill_controller_updateChange_Position = function(){
	var data = this._drill_data;
...
// * B变化控制 - 帧刷新 旋转
//==============================
Drill_ASu_Controller.prototype.drill_controller_updateChange_Rotation = function(){
	var data = this._drill_data;
...
// * C播放GIF - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_controller_initGIF = function() {
	var data = this._drill_data;
...
// * C播放GIF - 帧刷新
//==============================
Drill_ASu_Controller.prototype.drill_controller_updateGIF = function(){
	var data = this._drill_data;
...
// * D环绕轨迹 - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_controller_initSurround = function() {
	var data = this._drill_data;
...
// * D环绕轨迹 - 帧刷新
//==============================
Drill_ASu_Controller.prototype.drill_controller_updateSurround = function(){
	var data = this._drill_data;
	
	// > 层级变化（实际在界面中 drill_ASu_updateInScene 进行层级变化）
...
// * E自动调整效果 - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_controller_initAuto = function() {
	var data = this._drill_data;
	// （无）
}
...
// * 2A阶段 - 初始化子功能
//==============================
Drill_ASu_Controller.prototype.drill_ASu_initState = function() {
...
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_setController = function( controller ){
...
//			返回：	> 无
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_setAnimationSprite = function( animation_sprite ){
...
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_setIndividualSprite = function( individual_sprite ){
...
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_initChild = function(){
...
//			说明：	> 这里完全 不考虑 延迟加载问题。
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_isReady = function(){
...
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_isOptimizationPassed = function(){
    return true;
};
//##############################
// * 环绕球贴图 - 是否需要销毁【标准函数】
...
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_isNeedDestroy = function(){
...
//##############################
Drill_ASu_Sprite.prototype.drill_sprite_destroy = function(){
...
// * 环绕球贴图 - 初始化自身（私有）
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_initSelf = function(){
...
// * 环绕球贴图 - 销毁子功能（私有）
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_destroyChild = function(){
...
// * 环绕球贴图 - 销毁自身（私有）
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_destroySelf = function(){
	this._drill_controller = null;				//控制器对象
	this._drill_curSerial = -1;					//当前序列号
	this._drill_individualSprite = null;		//个体贴图（指针）
	this._drill_animationSprite = null;			//动画贴图（指针）
...
// * A主体 - 初始化子功能
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_initAttr = function(){
...
// * A主体 - 帧刷新
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_updateAttr = function(){
	var data = this._drill_controller._drill_data;
...
// * B变化控制 - 初始化子功能
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_initChange = function(){
	var data = this._drill_controller._drill_data;
	//	（无）
}
//==============================
// * B变化控制 - 帧刷新
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_updateChange = function(){
	var data = this._drill_controller._drill_data;
	var xx = this._drill_controller._drill_x;
	var yy = this._drill_controller._drill_y;
	
	
	// > 层级位置修正（实际在界面中 drill_ASu_updateInScene 进行层级变化）
...
// * D环绕轨迹 - 初始化子功能
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_initSurround = function(){
	var data = this._drill_controller._drill_data;
...
// * D环绕轨迹 - 帧刷新
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_updateSurround = function(){
	var data = this._drill_controller._drill_data;
...
// * E自动调整效果 - 初始化子功能
//==============================
Drill_ASu_Sprite.prototype.drill_sprite_initAuto = function(){
	var data = this._drill_controller._drill_data;
