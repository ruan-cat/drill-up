 ...
 * 插件指令：>信息面板N : 打开面板
 *
 * 插件指令：>信息面板N : 显示选项 : 选项[1]
 * 插件指令：>信息面板N : 显示选项 : 选项变量[21]
 * 插件指令：>信息面板N : 隐藏选项 : 选项[1]
 * 插件指令：>信息面板N : 隐藏选项 : 选项变量[21]
 * 插件指令：>信息面板N : 显示全部选项
 * 插件指令：>信息面板N : 隐藏全部选项
 * 
 * 插件指令：>信息面板N : 锁定选项 : 选项[1]
 * 插件指令：>信息面板N : 锁定选项 : 选项变量[21]
 * 插件指令：>信息面板N : 解锁选项 : 选项[1]
 * 插件指令：>信息面板N : 解锁选项 : 选项变量[21]
 * 插件指令：>信息面板N : 锁定全部选项
 * 插件指令：>信息面板N : 解锁全部选项
 *
 ...
 * 
 * 插件指令：>信息面板N : 选中选项 : 选项[1]
 * 插件指令：>信息面板N : 选中选项 : 选项变量[21]
 * 
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_SSpN_PluginTip_curName = "Drill_SceneSelfplateN.js 面板-全自定义信息面板N";
	DrillUp.g_SSpN_PluginTip_baseList = [
	...
	//==============================
	DrillUp.drill_SSpN_getPluginTip_NoBasePlugin = function(){
		if( DrillUp.g_SSpN_PluginTip_baseList.length == 0 ){ return ""; }
		var message = "【" + DrillUp.g_SSpN_PluginTip_curName + "】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对：";
		for(var i=0; i < DrillUp.g_SSpN_PluginTip_baseList.length; i++){
			message += "\n- ";
			message += DrillUp.g_SSpN_PluginTip_baseList[i];
		}
		return message;
	};
	...
	if( command === ">信息面板N" ){
		...
		if(args.length == 2){
			...
			if( type == "显示全部选项" || type == "显示全部" ){
				...
				StorageManager.drill_SSpN_saveData();
			}
...
// ** ☆主菜单选项
//
//			说明：	> 此模块专门关联主菜单选项，选项进入后跳转到 信息面板N 界面。
//					（插件完整的功能目录去看看：功能结构树）
//=============================================================================
...
// ** ☆标题选项
//
//			说明：	> 此模块专门关联标题选项，选项进入后跳转到 信息面板N 界面。
//					（插件完整的功能目录去看看：功能结构树）
//=============================================================================	
...
// * 信息面板N（场景基类） - 开始运行
//==============================
Scene_Drill_SSpN.prototype.start = function() {
    Scene_MenuBase.prototype.start.call(this);
};
//==============================
// * 信息面板N（场景基类） - 结束运行
//==============================
Scene_Drill_SSpN.prototype.stop = function() {
    Scene_MenuBase.prototype.stop.call(this);
};
//==============================
// * 信息面板N（场景基类） - 判断是否激活/启动
//==============================
Scene_Drill_SSpN.prototype.isActive = function() {
	return Scene_MenuBase.prototype.isActive.call(this);
};
//==============================
// * 信息面板N（场景基类） - 析构函数
//==============================
Scene_Drill_SSpN.prototype.terminate = function() {
...
// * 信息面板N（场景基类） - 判断加载完成
//==============================
Scene_Drill_SSpN.prototype.isReady = function() {
	return Scene_MenuBase.prototype.isReady.call(this);
};
//==============================
// * 信息面板N（场景基类） - 忙碌状态
//==============================
Scene_Drill_SSpN.prototype.isBusy = function() {
	return Scene_MenuBase.prototype.isBusy.call(this);
};

//==============================
// * 信息面板N（菜单界面基类） - 创建 - 菜单背景
//==============================
Scene_Drill_SSpN.prototype.createBackground = function() {
	Scene_MenuBase.prototype.createBackground.call(this);
};
//==============================
// * 信息面板N（菜单界面基类） - 创建 - 帮助窗口
//==============================
Scene_Drill_SSpN.prototype.createHelpWindow = function() {
...
//=============================================================================
		...
		var pluginTip = DrillUp.drill_SSpN_getPluginTip_NoBasePlugin();
		alert( pluginTip );
}
