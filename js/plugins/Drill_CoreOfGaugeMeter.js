 ...
 * 需要基于核心才能运行，并作用于子插件：
 * 基于：
 *   - Drill_CoreOfBallistics       数学模型-弹道核心★★v1.6及以上★★
 * 作用于：
...
//		
//		★存在的问题：
//			1.问题：同时开7个缓冲时间条，并且弹出条开启。210个弹出条同时运动时，地图界面会卡爆。
//			  解决：【未解决】
//		
...
//=============================================================================
	...
	DrillUp.g_COGM_PluginTip_baseList = ["Drill_CoreOfBallistics.js 数学模型-弹道核心"];
	//==============================
	// * 提示信息 - 报错 - 缺少基础插件
	//			
