 ...
 * -----------------------------------------------------------------------------
 * ----可选设定
 * 你可以通过插件指令，手动设置当前的遇敌动画效果。
 *
 * 插件指令：transition_effect : X
 *
 * 参数X：动画类型
 *        -1- 默认
 *        0 - 粉碎方块-向左飘
 *        1 - 粉碎方块-向下落
 *        2 - 模糊（该类型会严重影响游戏速度，最好不考虑使用）
 *        3 - 噪点
 *        4 - 随机
 *
 */
...
　　var Moghunter = Moghunter || {}; 
	...
	Moghunter.btrEffectsDefault = Number(Moghunter.parameters['默认遇敌动画'] || -1);
