...
(() => {
	...
	Scene_Logo.prototype.increasingOpacityPerFrame = function () {
		switch (this._logoIndex) {
			case 0:
				return Math.ceil(255 / LOGO1_FADEIN_FRAMES);
			case 1:
				return Math.ceil(255 / LOGO2_FADEIN_FRAMES);
			case 2:
				return Math.ceil(255 / LOGO3_FADEIN_FRAMES);
			default:
				return 22;
		}
	};
	...
	Scene_Logo.prototype.decreasingOpacityPerFrame = function () {
		switch (this._logoIndex) {
			case 0:
				return Math.ceil(255 / LOGO1_FADEOUT_FRAMES);
			case 1:
				return Math.ceil(255 / LOGO2_FADEOUT_FRAMES);
			case 2:
				return Math.ceil(255 / LOGO3_FADEOUT_FRAMES);
			default:
				return 22;
		}
	};
		...
		switch (this._logoIndex) {
			case 0:
				if (LOGO1_IMAGE_NAME) {
					...
					switch (this._phase) {
						case 0:
							maxDuration = LOGO1_FADEIN_FRAMES;
							break;
						case 2:
							maxDuration = LOGO1_FADEOUT_FRAMES;
							break;
						default:
							maxDuration = LOGO1_DURATION_FRAMES;
							break;
					}
				} else {
					this._logoIndex++;
			...
			case 1:
				if (LOGO2_IMAGE_NAME) {
					...
					switch (this._phase) {
						case 0:
							maxDuration = LOGO2_FADEIN_FRAMES;
							break;
						case 2:
							maxDuration = LOGO2_FADEOUT_FRAMES;
							break;
						default:
							maxDuration = LOGO2_DURATION_FRAMES;
							break;
					}
				} else {
					this._logoIndex++;
			...
			case 2:
				if (LOGO3_IMAGE_NAME) {
					...
					switch (this._phase) {
						case 0:
							maxDuration = LOGO3_FADEIN_FRAMES;
							break;
						case 2:
							maxDuration = LOGO3_FADEOUT_FRAMES;
							break;
						default:
							maxDuration = LOGO3_DURATION_FRAMES;
							break;
					}
				} else {
					this._logoIndex++;
