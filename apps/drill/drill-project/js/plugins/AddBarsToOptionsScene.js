...
(function () {
	...
	Window_Options.prototype.addBar = function (index) {
		...
		if (this.isVolumeSymbol(symbol)) {
			...
			//タッチされたかどうか判定
			var _on_touch_button = this.isTouchButton(
				rect.x + this.button_position[index],
				rect.y + $bar_position_ABOS_Y - 3,
			);
			...
			this.drawBar(
				rect.x + $bar_position_ABOS,
				rect.y + $bar_position_ABOS_Y,
				rect.x + $bar_position_ABOS + $bar_length_ABOS,
				rect.y + $bar_position_ABOS_Y - 3,
				$bar_color_ABOS,
				6,
				index,
