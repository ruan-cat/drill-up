	...
	if (hide || !this.inputtingStatus || !this._list || (this._list && this._list.length <= 0) || this.index() < 0) {
		...
		if (ext.inputType == 0) {
			...
			if (ext.inputType == 1) {
				this.setElement(
					this.inputElement,
					this.x + rect.x + rect.width + 18,
					this.y + rect.y + 18 + (-this.scrollY() % this.itemHeight()),
				);
				if (this.editingData) {
...
ParticleQJRenderer.prototype.render = function render(container) {
	...
	this.shader.uniforms.uColor = utils.premultiplyRgba(
		container.tintRgb,
	...
	for (var i = 0; i < amount; ++i) {
		...
		var argb =
			alpha < 1.0 && premultiplied
				? PIXI.utils.premultiplyTint(sprite._tintRGB, alpha)
...
if (!PIXI.filters.EmbossFilter) {
	...
	var __filters = (function (e, t, n, r, o, i, l, s) {
				...
				return (
					(n.color.set = function (e) {
						...
						"number" == typeof e
							...
							: ((t[0] = e[0]), (t[1] = e[1]), (t[2] = e[2]), (this._color = o.rgb2hex(t)));
					}),
				...
				return (
					(n.originalColor.set = function (e) {
						...
						"number" == typeof e
							...
							: ((t[0] = e[0]), (t[1] = e[1]), (t[2] = e[2]), (this._originalColor = o.rgb2hex(t)));
					}),
					...
					(n.newColor.set = function (e) {
						...
						"number" == typeof e
							...
							: ((t[0] = e[0]), (t[1] = e[1]), (t[2] = e[2]), (this._newColor = o.rgb2hex(t)));
					}),
		...
		ae.defaults = { distance: 10, outerStrength: 4, innerStrength: 0, color: 16777215, quality: 0.1, knockout: !1 };
		var ue = a,
			ce =
			...
			he = (function (e) {
				function t(t) {
					(e.call(this, ue, fe.replace("${perlin}", ce)),
						...
						(t = Object.assign({ angle: 30, gain: 0.5, lacunarity: 2.5, time: 0, parallel: !0, center: [0, 0] }, t)),
				...
				return (
					...
					(r.velocity.set = function (e) {
						Array.isArray(e)
							...
							: (e instanceof n.Point || e instanceof n.ObservablePoint) && this._velocity.copyFrom(e);
					}),
			...
			Ge = (function (e) {
				...
				return (
					...
					(n.color.set = function (e) {
						...
						"number" == typeof e
							? (o.hex2rgb(e, t), (this._color = e))
							: ((t[0] = e[0]), (t[1] = e[1]), (t[2] = e[2]), (t[3] = e[3]), (this._color = o.rgb2hex(t)));
					}),
					(n.color.get = function () {
						return this._color;
					}),
...
Sprite_ParticleShatterQJ.prototype.initialize = function (baseTexture, frame = "0|0~90/30~30/600") {
	//baseTexture or renderTexture
...
Sprite_ParticleShatter2QJ.prototype.initialize = function (
	baseTexture,
	frame1 = "0|0~80/5",
	frame2 = "0|1~20/0.3~60/0",
) {
	//baseTexture or renderTexture
	Sprite_ParticleContainerQJ.prototype.initialize.call(this, {
		rotation: false,
