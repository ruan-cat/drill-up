...
(($ = {}) => {
	...
	if (!Imported.QJCore) {
		QJ.getPointer = function () {
			return QJ.Pointer
				? typeof QJ.Pointer == "number"
					? QJ.getCharacter(QJ.Pointer)
					: QJ.Pointer.eventId
						? $gameMap.event(QJ.Pointer.eventId())
						: QJ.Pointer
				: null;
		};
		QJ.getPointerId = function () {
			return typeof QJ.Pointer == "number"
				? $gameMap.event(QJ.Pointer).eventId()
				: $gameMap.event(QJ.Pointer.eventId()).eventId();
		};
