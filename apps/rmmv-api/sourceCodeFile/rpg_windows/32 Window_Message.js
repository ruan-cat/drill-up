...
Window_Message.prototype.createSubWindows = function() {
    ...
    /**
     * 建造辅助窗口、包括 Window_ChoiceList 选择列表窗口
     */
 ...
 * 开始消息
 * 
 * 主调方法：Window_Message.prototype.update
 */
...
Window_Message.prototype.updateMessage = function() {
    if (this._textState) {
        while (!this.isEndOfText(this._textState)) {
            ...
            this.updateShowFast();
            //处理字符。同时输出内容。核心的输出在于相关的 Window_Base.prototype.processNormalCharacter 方法。
 ...
 * @param {*} textState 
 * @description
 * 主调方法： updateMessage、startMessage
 * 
 * 新页
 */
...
/**
 * @description
 * 主调方法：Window_Message.prototype.newPage
 */
