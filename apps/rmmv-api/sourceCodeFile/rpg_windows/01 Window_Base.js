 ...
 * @param {*} height
 * @description
 * openness变量主要和_opening _closing变量配合。这两个变量完成了openness变量的数值变量。
 */
 ...
 *
 * 主调方法：
 * Window_Base.prototype.initialize 、 Window_Base.prototype.update
 */
...
Window_Base.prototype.createContents = function () {
	/**
	 * contents的本质并不是一个独立的位图，而是this._windowContentsSprite.bitmap
	 * 这里的内容是初步设置其具体位图的内容。
	 */
 ...
 * @description
 * 打开
 * Window_Base._opening 和 Window_Base._closing 是什么意思？
 */
...
/**
 * @description
 * 主调方法：Window_Base.prototype.resetTextColor
 * @param {} color
 */
...
/**
 * @description
 * 主调方法：Window_Command.prototype.drawItem
 * @param {*} enabled
 */
 ...
 * 绘制文本
 *
 * 窗口绘制文本都是书写在contents内，即_windowContentsSprite。
 */
...
/**
 * @description
 * 基本上是： updateBackground方法
 * @param {*} type 来源于 Game_Message._choiceBackground 的储存值。
 */
